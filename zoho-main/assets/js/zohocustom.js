...
$(".zw-global-header").append(
  '<div class="header"> <a class="logo" href="https://www.zoho.com/"> ZOHO </a> <div class="signing"></div> </div> <div class="product-header-top slide"> <div class="content-wrap"> <div class="product-title"><a href="/' +
    $("body").attr("data-prdname") +
    '/">' +
    $("body").attr("data-prdname-display") +
    '</a></div> <div class="zgh-accounts"><a href="https://accounts.zoho.com/signin?servicename=Zohohome&amp;signupurl=https://www.zoho.com/signup.html&amp;serviceurl=https://home.zoho.com" class="zgh-login" style="display: none;">SIGN IN</a><a href="/signup.html?src=index1" class="zgh-signup" style="display: inline-block;">' +
...
var dcVal = "0",
  ...
  currentYear = "2024",
  creativeLang = "",
  knowprd = typeof document
    .getElementsByTagName("body")[0]
    .getAttribute("data-prdname");
var _preZ = "prezohoweb.zoho.com",
  _preZC = "prezohoweb.zohocorp.com",
  _zcmsZC = "zcmsweb.zohocorp.com",
  _zcopr = "zohocorp",
  _lz = "localzoho",
  _preccms = "ccms.zohocorp.com",
  _prewww = "prewww";
if (Zdomain == _zcopr) {
  Zdomain = "zoho";
}
...
var bannertext = {
  ...
  "hi-in":
    "à¤¨à¤®à¤¸à¥à¤•à¤¾à¤° ::: à¤…à¤¬ à¤†à¤ª à¤¨à¥‡à¤µà¤¿à¤—à¥‡à¤Ÿ à¤•à¤° à¤¸à¤•à¤¤à¥‡ à¤¹à¥ˆà¤‚à¥¤",
};
var localRedirectionlist = {
  "es-xl":
    "BZ,CR,SV,GT,HN,MX,NI,PA,AR,BO,BR,CL,CO,EC,GY,PY,PE,SR,UY,VE,CU,DO,HT,PR,BL,MF",
  fr: "FR",
  nl: "NL",
  ar: "SA,EG",
  "pt-br": "BR",
...
var predomain =
  window.location.hostname == _preZ ||
  window.location.hostname == _preZC ||
  Zdomain == _lz ||
...
var customvar = {
  ...
  domainArr: [
    ["com", "in", "eu", "com.au", "jp"],
    [],
    ["zoho.com", "zoho.in", "zoho.eu", "zoho.com.au", "zoho.jp"],
  ],
  pArr: [
    "accounts",
    "notebook",
  ...
  productTermList: {
    ...
    marketingautomation:
      "https://www.zoho.com/marketingautomation/terms-of-service.html",
  ...
  getPrivacyLink: function (m, l, z, A) {
    ...
    if ($(".globalstatecode").length > 0 || l) {
      ...
      if (p) {
        if (
          !customvar.usstates.includes(p) ||
          !customvar.instates.includes(p)
        ) {
    ...
    return { footerPrivacyLink: x, signupPrivacyLink: s, crmPrivacyLink: n };
  },
  ...
  getCountryDetails: function (l) {
    ...
    return { country: l, countryCode: j, dialCode: h };
  },
  ...
  termslink: (function () {
    return (function () {
      var h = "https://www.zoho.com/jp/terms.html";
      var l = null;
      function j(o, p) {
        if (p && p.length && p.includes(currentUrlLang)) {
          if (typeof o == "string") {
            o = o
              .split(customvar.productName)
              .join(currentUrlLang + "/" + customvar.productName);
          }
        }
        if (Array.isArray(o)) {
      ...
      return { setProductTerm: j, setDefaultTerm: k };
    })();
  })(),
  gdprshowhide: function () {
    ...
    if (
      customvar.optinArr.includes(h) ||
      customvar.optoutArr.includes(h) ||
      customvar.doubleoptinArr.includes(h) ||
      customvar.countryEu.includes(h)
    ) {
      (j = false), (k = false);
    }
    return { hide: j, check: k };
  },
  lsoinfo: function (o) {
  ...
  stateadd: function () {
    ...
    var j =
      "US" == CountryCode
        ? customvar.usstates
        : "IN" == CountryCode && customvar.instates;
    arguments.length > 0 &&
      ("US" == arguments[0] || "United States" == arguments[0]
        ? (j = customvar.usstates)
        : ("IN" != arguments[0] && "India" != arguments[0]) ||
          (j = customvar.instates));
    for (var h = 0; h < j.length; h++) {
      if (j.indexOf(customvar.instates[1] > -1) && h == 0) {
        this._val += '<option value="select your state">' + j[h] + "</option>";
      } else {
        this._val +=
          '<option value="' + j[h].toLowerCase() + '">' + j[h] + "</option>";
      }
    }
  ...
  countrypop: function (h) {
    ...
    for (var j = 0; j < customvar.countries[0].length; j++) {
      if (h == "dial") {
        ...
        this._val = "0";
        customvar.optinArr.indexOf(this.arr[1][j]) > -1
          ? (this._val = "2")
          : customvar.optoutArr.indexOf(this.arr[1][j]) > -1
          ? (this._val = "2")
          : customvar.doubleoptinArr.indexOf(this.arr[1][j]) > -1
          ? (this._val = "3")
          : "";
        this._data +=
          '<option value="' +
        ...
        if ($(".dc-info").length > 0 && $(".za-state-container").length < 1) {
          ...
          if (stateupdate.indexOf(customvar.productName) > -1) {
            ...
            for (var m = 0; m < customvar.usstates.length; m++) {
              this._val +=
                '<option value="' +
                customvar.usstates[m].toLowerCase() +
                '">' +
                customvar.usstates[m] +
                "</option>";
            }
            $(".dc-info").after(
          ...
          if (
            CountryCode == "US" ||
            (CountryCode == "IN" &&
              stateupdate.indexOf(customvar.productName) > -1)
          ) {
            if (customvar.showchangecountry == "true") {
              $(".za-state-container")
                .removeClass("zhide-common")
                .addClass("zshow-common");
            }
            if (CountryCode == "US") {
              $(".za-globalstate-signup option").eq(0).remove();
              $(".za-globalstate-signup").val(
  ...
  dcselected: function (h) {
    if (
      h == "US" ||
      (h == "IN" && stateupdate.indexOf(customvar.productName) > -1)
    ) {
      if ($(".za-globalstate-signup").length > 0) {
        if (
          $(".za-globalstate-signup option").eq(0).val() == "" ||
      ...
      $(".za-state-container")
        .removeClass("zshow-common")
        .addClass("zhide-common");
    }
      ...
      if ($(".zrlink").length > 0 && h == "US") {
        if ($(".za-globalstate-signup").val().toLowerCase() == "california") {
          if (
            ...
            $(".zrlink").attr(
              "href",
              "https://www.manageengine.com/us-ca/privacy.html"
            );
          } else {
            $(".zrlink").attr(
              "href",
              "https://www.zoho.com/us-ca/privacy.html"
            );
          }
        } else {
          if (
            ...
            $(".zrlink").attr(
              "href",
              "https://ondemand.manageengine.com/privacy.html"
            );
          } else {
    ...
    for (b in j) {
      for (c in j[b]) {
        ...
        if (c.indexOf(".act-btn.cta-btn") > -1) {
          if (b == "href") {
            $(
              ".zgh-userAccess a, .loggedin-userinfo .access-apps, .z-bottom-cta-menu  .loggedin"
            ).attr("href", h);
          } else {
            if (b == "html") {
              $(
  ...
  loadlangxml: function () {
    ...
    k.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (q[0].length > 0) {
          if (
            $("body").hasClass("i18n-zh-hans") &&
            q[1].indexOf("zh-hans") < 0
          ) {
        ...
        var x =
          location.search.indexOf("zredirect=f") < 0
            ? location.search + v + "zredirect=f&zsrc=langdropdown"
            : location.search;
        ...
        for (var p = 0; p < q[0].length; p++) {
          if (predomain && _lhref.includes(_preZ + "/index-new1.html")) {
            ...
            var u =
              window.location.origin + "/" + q[0][p].split("zoho.com/")[1] + n;
            if (q[1][p] == "zh-hans") {
              u = q[0][p] + n;
            }
            if (customvar.outproduct.indexOf(customvar.productName) > -1) {
              if (window.location.host.includes("prewww")) {
                u =
                  ...
                  "/" +
                  q[0][p].split(
                    window.location.host.split("pre").join("") + "/"
                  )[1] +
                  n;
              } else {
                u =
                  window.location.origin +
                  "/" +
                  q[0][p].split(window.location.host + "/")[1] +
                  n;
              }
            }
            if (q[1][p] == l) {
            ...
            if (
              ((currentUrlLang == "" && q[1][p] != "en") ||
                t ||
                currentUrlLang != "") &&
              q[1][p] != currentUrlLang
            ) {
              var n = q[1][p] == "en" ? x + "&lb=" + currentUrlLang : x;
              var u =
                window.location.origin +
                "/" +
                q[0][p].split("zoho.com/")[1] +
                n;
              if (q[1][p] == "zh-hans") {
                u = q[0][p] + n;
              }
        ...
        if (typeof CountryCode != "undefined") {
          if (domainOne != "in") {
            if (
              global_getUrlParam("zc_localredirection") === "" &&
              customvar.productName !== "startups"
            ) {
              langStrip();
            }
          }
    ...
    if (
      !(customvar.productName == "mail" || customvar.productName == "zeptomail")
    ) {
      h = "";
    }
    if (window.location.host == _preZ) {
      if (customvar.productName == "community") {
        ...
        if (customvar.productName == "crmplus") {
          k.open(
            "GET",
            window.location.origin + "/crm/" + j + h + "sitemap.xml",
            true
          );
        } else {
          k.open("GET", "https://" + _preZ + "/" + j + h + "sitemap.xml", true);
      ...
      if (customvar.productName == "crmplus") {
        ...
        if (window.location.host.indexOf("zohoflow") > 0) {
          ...
          if (
            ...
            if (
              window.location.origin.indexOf("orchestly") > 0 ||
              window.location.origin.indexOf("trainercentral") > 0 ||
              window.location.origin.indexOf("catalyst") > 0
            ) {
              k.open(
                "GET",
                "https://www.zoho.com/" + j + h + "sitemap.xml",
                true
              );
            } else {
              k.open(
                "GET",
                window.location.origin + "/" + j + h + "sitemap.xml",
                true
              );
            }
          } else {
          ...
          if (typeof l.eq(p).attr("data-video") != "undefined") {
            if (l.eq(p).attr("data-video").indexOf("vimeo") > -1) {
              var n = o
                .attr("data-video")
                .split("/")
                [o.attr("data-video").split("/").length - 1].split("?")[0];
  ...
  zChaSupIDByReg: function () {
    var j = [
      ...
      [
        "workplace",
        "support@zohoworkplace.com",
        "support@eu.zohoworkplace.com",
      ],
    ];
    for (var h = 0; h < j.length; h++) {
  ...
  findMailToReplace: function (h) {
    if (
      $('a[href="mailto:' + h.global + '"]').length > 0 &&
      typeof h[dcdomainOne] != "undefined"
    ) {
      $('a[href="mailto:' + h.global + '"]').html(h[dcdomainOne]);
      $('a[href="mailto:' + h.global + '"]').attr(
        "href",
        "mailto:" + h[dcdomainOne]
      );
    }
  },
  dcadded: function (k) {
  ...
  comp_disclaimer: function () {
    if ($(".zcomp-disclaimer").length > 0) {
      if ($(".zcomp-disclaimer").attr("data-pricingvalue")) {
        var h =
          Drupal.t(
            "All names and marks mentioned here remain the property of their original owners. Details are as published by the named competitors on their website(s) on"
          ) +
          " " +
          $(".zcomp-disclaimer").attr("data-disclaimer-date") +
          " " +
          Drupal.t(
            "and are subject to change without notice. The details provided on this page are for general purposes only and cannot be considered as authorized information from the respective competitors. Zoho disclaims any liability for possible errors, omissions, or consequential losses based on the details here."
          );
        $(".zcomp-disclaimer").html(h);
      } else {
        var h =
          Drupal.t(
            "All names and marks mentioned here remain the property of their original owners. Prices are as published by the named competitors on their website(s) as on"
          ) +
          " " +
          $(".zcomp-disclaimer").attr("data-disclaimer-date") +
          " " +
          Drupal.t(
            "(without taking into account the taxes or discounts), and are subject to change based on the pricing policies of the competitors. The details provided on this page are for general purposes only and cannot be considered as authorized information from the respective competitors. Zoho disclaims any liability for possible errors, omissions, or consequential losses based on the details here."
          );
        $(".zcomp-disclaimer").html(h);
      }
    }
    ...
    if ($(".zw-support-mail-links").length > 0) {
      if (typeof customvar.supportId != "undefined") {
        $(".zw-support-mail-links").append(
          '<a id="zf-support-mailid" href="mailto:' +
            customvar.supportId() +
            '">' +
            customvar.supportId() +
            "</a>"
        ...
        $(".zw-support-mail-links").append(
          '<a id="zf-support-mailid" href="mailto:support@zoho.com">support@zoho.com</a>'
        );
      }
    }
  }
...
if (predomain) {
  customvar.dcObj.ca["notavailable"] = customvar.dcObj.ca[
    "notavailable"
  ].filter(function (h) {
    return h != "workerly";
  });
  ...
  customvar.dcObj.sa["notavailable"] = customvar.dcObj.sa[
    "notavailable"
  ].filter(function (h) {
    return h != "developer";
  });
...
customvar.findproduct = (function () {
  if (knowprd) {
    customvar.productName = document
      .getElementsByTagName("body")[0]
      .getAttribute("data-prdname")
      .replace(/ /g, "");
...
if (predomain) {
  customvar.newFooterProducts = customvar.newFooterProducts.concat([
    "workerly",
    "routeiq",
  ]);
}
...
var refound =
  currentUrlLang == "jp"
    ? (refound =
        "<li><a href='//www.zoho.com/jp/refund.html'>&#12458;&#12531;&#12521;&#12452;&#12531;&#27770;&#28168;&#24460;&#12398;&#12461;&#12515;&#12531;&#12475;&#12523;&#12395;&#12388;&#12356;&#12390;</a></li>")
    : "";
...
var czone_footer =
  ...
  '</a></li><li class="cookie-policy"><a href="https://www.zoho.com' +
  langsrc +
...
var myAccount = Drupal.t("My Account"),
  ...
  _txtIwould =
    ...
    ' <a href="https://www.zohocorp.com/" name="zohos" target="_blank">' +
    Drupal.t("Zoho&rsquo;s") +
    "</a> " +
    Drupal.t(
      "products, services, and events from Zoho and its regional partners."
    ),
...
if (currentUrlLang == "jp") {
  _txtIwould =
    Drupal.t("Yes, I would like to receive marketing communication regarding") +
    ' <a href="https://www.zohocorp.com/" target="_blank">' +
    Drupal.t("Zoho") +
    "</a> " +
    Drupal.t(
      "products, services, and events from Zoho and its regional partners."
...
(function (h) {
  (customvar.email = Drupal.t("Email")),
    ...
    (customvar.eValidMobileNumber = Drupal.t(
      "Please enter valid mobile number"
    )),
    (customvar.eReMobileNumber = Drupal.t(
      "Please re-enter valid mobile number"
    )),
    ...
    (customvar.enterotpmobile = Drupal.t(
      "Enter the one-time password sent to your mobile number."
    )),
    (customvar.enterotpemail = Drupal.t(
    ...
    (customvar.otpEle =
      ...
      '</div> <div class="otpmobile"> <span id="mobileotp"></span> <span class="change" onclick="zwc_gobacktosignup()">' +
      Drupal.t("Change") +
      '</span> </div> <span class="za-otp-container" style="display: none;"> <input type="text" class="form-input" tabindex="1" name="otp" id="otpfield" placeholder="' +
      Drupal.t("Enter OTP") +
      '" disabled="disabled"> <span onclick="resendOTP()" class="resendotp">' +
      Drupal.t("Resend OTP") +
      '</span> </span> <span class="za-submitbtn-otp"> <input type="button" tabindex="1" class="signupbtn" value="' +
      Drupal.t("VERIFY") +
...
if (
  customvar.africaRegList.indexOf(
    customvar.countries[0][customvar.countries[1].indexOf(CountryCode)]
  ) > -1
) {
...
customvar.bodyclass = (function () {
  ...
  if (
    (currentUrlLang != "" && currentUrlLang != "en") ||
    domainOne == "com.cn"
  ) {
  ...
  customvar.zmr = customvar.removequots(
    customvar.getGlobalCookie("ZohoMarkRef")
  );
  customvar.zms = customvar.removequots(
    customvar.getGlobalCookie("ZohoMarkSrc")
  );
  customvar.isEU = customvar.countryEu.indexOf(CountryCode) > -1 ? true : false;
  customvar.isAPAC =
    customvar.countryApac.indexOf(CountryCode) > -1 ? true : false;
...
customvar.vimcall = function () {
  if (currentUrlLang == "jp" && customvar.productName == "desk") {
    ...
    if (
      $(".zcpopup-controller").length > 0 ||
      $(".popup-controller").length > 0
    ) {
      customvar.vimovid();
    }
  }
...
function global_getUrlParam(j) {
  var l = {},
    h = "";
  var k = window.location.href.replace(
    /[?&]+([^=&]+)=([^&]*)/gi,
    function (n, o, p) {
      l[o] = p;
      if (o == j) {
...
if (
  customvar.pathname.indexOf("creator/developers/signup.html") > 0 ||
  customvar.absurl.indexOf("creator/payroll") > 0
) {
  ...
  if (
    ...
    $(".zw-only-copyright .content-wrap").append(
      "<p>&copy; " +
        currentYear +
        ", " +
        Drupal.t("ZOHO Japan Corporation. All Rights Reserved.") +
        "</p>"
    );
  } else {
...
if (
  ...
  (typeof $("body").attr("site") != "undefined" &&
    $("body").attr("site") == "o-cms")
) {
  loadxml = false;
}
if (loadxml) {
...
global_getUrlParam("hideglobalheader") != ""
  ? $("body").addClass("hideglobalheader")
  : "";
global_getUrlParam("hideproductheader") != ""
  ? $("body").addClass("hideproductheader")
  : "";
global_getUrlParam("hideglobalfooter") != ""
  ? $("body").addClass("hideglobalfooter")
  : "";
global_getUrlParam("hideproductfooter") != ""
  ? $("body").addClass("hideproductfooter")
  : "";
global_getUrlParam("hidebottomcta") != ""
  ? $("body").addClass("hidebottomcta")
  : "";
...
(function () {
  if (currentUrlLang != "jp") {
    ...
    if (document.domain.split("")[document.domain.length - 1] == ".") {
      var j =
        window.location.href.split(getDomain)[0] +
        "" +
        k +
        "" +
        window.location.href.split(getDomain)[1];
    ...
    if (!h.includes(customvar.productName)) {
      if (_preZ == window.location.hostname) {
        $.getScript(
          "https://" + _preZ + "/sites/zweb/js/common/dynamicemail.js"
        );
      } else {
        $.getScript(
          "https://www.zoho.com/sites/zweb/js/common/dynamicemail.js"
        );
      }
    }
  }
...
var addDynamicScript = (function () {
  ...
  return function (l) {
    ...
    if (j[l]) {
      ...
      if (
        window.location.host === _preZ ||
        parent.document.location.host === _preZ
      ) {
        l = "https://" + _preZ + j[l];
      } else {
    ...
    if (
      document.querySelectorAll('script[src*="' + k + '"]').length === 0 &&
      !h[k].needToLoad
    ) {
      h[k].needToLoad = true;
    }
  ...
  if (
    ...
    if (global_getUrlParam("zc_localredirection") != "") {
      if (typeof localRedirectionlist[currentUrlLang] != "undefined") {
        if (
          localRedirectionlist[currentUrlLang].split(",").indexOf(CountryCode) >
          -1
        ) {
          if (customvar.lsoinfo("latinNavigate") == "") {
            var mlang = window.location.href
              .split("/" + currentUrlLang + "/")
              .join("/");
            $(".ztopstrip-container").css("display", "block");
            $(".ztopstrip-container").append(
              '<div class="lbanner" style="display:block"> <span class="langTxt">' +
                Drupal.t("Hello! Do you want to navigate in English?") +
                '</span><span class="langClose">X</span> </div>'
            );
...
customvar.clang =
  currentUrlLang == "" ? "" : "service_language=" + currentLang + "&";
...
var _txtBySubmit =
  ...
  Drupal.t("Privacy Policy") +
  ".</a>";
customvar.ocmsprelink =
  window.location.hostname.indexOf(_prewww) > -1 ? "https://" + _preZ : "";
if (currentLang == "ar") {
  var arCount = 0;
...
_lhref.indexOf("mdm-cloud.html") > 0
  ? (prdName = "MobileDeviceManagement")
  : "";
_lhref.indexOf("online-service-desk-software.html") > 0
  ? (prdName = "ServiceDesk Plus")
  : "";
var _zclang = langsrc;
customvar.outproduct.indexOf(customvar.productName) > -1 ||
window.location.host == "catalyst.zoho.eu" ||
domainOne == "com.cn"
  ...
  : "";
var zghBrand =
  ' <div class="zgh-brand"><span class="zgh-menu"><span class="hamburger-box"><span></span><span></span><span></span><span></span><span></span><span></span></span></span><a href="' +
  _zclang +
  '">Zoho.com</a></div>';
var zghNav;
if (prdName == "home") {
  ...
  zghNav =
    ...
    Drupal.t("Products") +
    '</a><div class="zgh-megaMenuBox"><div class="zgh-megaMenuInner"><ul class="zgh-megaMenuCat"></ul><div class="zgh-megaMenuPro"></div></div></div></li><li><a href="https://www.zoho.com/customers.html">' +
    Drupal.t("Customers") +
    '</a></li><li><a href="' +
    _suportlink +
    '" target="_blank">' +
    Drupal.t("Support") +
    '</a></li><li><a href="https://www.zoho.com' +
    langsrc +
    'aboutus.html">' +
    Drupal.t("About Us") +
    "</a></li></ul></div>";
...
var zghUtil =
  '<div class="zgh-utilities">' + zghSearch + zghLoc + zghAcc + "</div>";
if (predomain && _lhref.includes(_preZ + "/index-new1.html")) {
  var zghNewHeadDiv =
    '<div class="zgh-announcement"><span class="zgh-announcement-icon"></span> <div class="zgh-announcement-container"></div></div>';
  var zghUtil =
...
var zghBlock =
  '<div class="zgh-headerWrap" id="header">' +
  zghBrand +
  zghNav +
  zghUtil +
  "</div>";
...
(function () {
  ...
  if (
    !(
      (customvar.getOS == "Mac" || customvar.getOS == "iOS") &&
  ...
  var l = ["tech-talk"];
  if (
    ($(".zw-product-header").length > 0 ||
      $(".zw-product-footer").length > 0) &&
    l.includes(customvar.productName) == false
  ) {
    if (
      _preZ == window.location.hostname ||
      ...
      if (typeof $("body").attr("data-domain") != "undefined") {
        if ($("body").attr("data-domain") == "oweb") {
          if (customvar.outproduct.indexOf(customvar.productName) > -1) {
            $.getScript(
              "https://www.zoho.com/sites/zweb/js/common/prod_menu.js"
            );
          } else {
            $.getScript(
              "https://" + _preZC + "/sites/zweb/js/common/prod_menu.js"
            );
          }
        }
      } else {
...
jQuery(document).ready(function () {
  ...
  jQuery(".zoho-parent-toggle").click(function () {
    if (
      !/\/reports\/help\//.test(document.URL) &&
      !/\/developer\/help\//.test(document.URL)
    ) {
  ...
  jQuery(".node-type-product-help #faq h4").click(function () {
    ...
    if (m) {
      ...
      if (jQuery(this).siblings().hasClass("open")) {
        if (
          jQuery(this)
            .siblings(".open .hidden-news, .open + .ans.dropBox")
            .is(":visible")
        ) {
          ...
          jQuery(".open .hidden-news, .open + .ans.dropBox").slideToggle(
            "slow"
          );
        }
      } else {
  ...
  var j = jQuery(
    "#block-panels-mini-products-header-dropdown-menu"
  ).innerHeight();
  ...
  jQuery(".zoho-home-page .scroll-down .scrolldown-arrow").click(function () {
    jQuery("body").animate(
      {
        scrollTop:
          jQuery(".pane-home-page-view-panel-pane-1").offset().top - h + 55,
      },
      1000
    );
  });
  jQuery(".view-home-page-view").each(function () {
    var m = 0;
    jQuery(
      ".view-grouping:nth-child(1),.view-grouping:nth-child(2),.view-grouping:nth-child(3)"
    ).each(function () {
  ...
  jQuery(".view-home-page-view").each(function () {
    var m = 0;
    jQuery(
      ".view-grouping:nth-child(4),.view-grouping:nth-child(5),.view-grouping:nth-child(6)"
    ).each(function () {
      if (jQuery(this).height() > m) {
        m = jQuery(this).height();
      }
  ...
  jQuery(".pricing-view-content-wrapper .pricing-row-wrapper").each(
    function () {
      var m = 0;
      jQuery(this)
  ...
  $('.zwc_zcounts[data-zcount-datacenters="true"]').html(
    '<span class="zwc_zcounts_digits">' +
      customvar.numberOfDataCenters +
      "</span>"
  );
  $('.zwc_zcounts[data-zcount-customers="true"]').html(
    '<span class="zwc_zcounts_digits">' +
      customvar.numberOfCustomers +
      "</span>"
  );
  var l = "000";
  $('.zwc_zcounts[data-zcount-employees-alldigits="true"]').html(
    '<span class="zwc_zcounts_digits">' +
      new Intl.NumberFormat(CountryCode).format(
        customvar.numberOfEmployees + l
      ) +
      "</span>"
  );
  ...
  if (dcdomainOne == "in") {
    $('.zwc_zcounts[data-zcount-employees-alldigits="true"]').html(
      '<span class="zwc_zcounts_digits">' +
        new Intl.NumberFormat("en-IN").format(customvar.numberOfEmployees + l) +
        "</span>"
    );
    $('.zwc_zcounts[data-zcount-partners-alldigits="true"]').html(
      '<span class="zwc_zcounts_digits">' +
        new Intl.NumberFormat("en-IN").format(customvar.numberOfPartners + l) +
        "</span>"
    );
  }
  $('.zwc_zcounts[data-zcount-plus="true"]').append(
    '<span class="zwc_zcounts_type">+</span>'
  );
  $('.zwc_zcounts[data-zcount-k="true"]').append(
    '<span class="zwc_zcounts_type">K</span>'
  );
  $('.zwc_zcounts[data-zcount-kplus="true"]').append(
    '<span class="zwc_zcounts_type">K+</span>'
  );
  $('.zwc_zcounts[data-zcount-million="true"]').append(
    '<span class="zwc_zcounts_type">M</span>'
  );
  $('.zwc_zcounts[data-zcount-millionplus="true"]').append(
    '<span class="zwc_zcounts_type">M+</span>'
  );
...
function expcollps(l, h) {
  ...
  if (h) {
    ...
    j.slideUp(700, function () {
      k.animate({ opacity: 1 }, 700).css("visibility", "visible");
    });
  }
}
function setSlidingMenuMobile() {
  if (langsrc == "/") {
    if (
      ...
      var h =
        '<div class="ztop-slide-mobile-menu"><div class="ztop-smm-inner">';
      var k = 0;
      $.each(j, function (l, m) {
        k++;
...
(function (h) {
  h(document).ready(function (ak) {
    ...
    if (z) {
      if (dcenabled && nondc) {
          ...
          h(r).on("load", function () {
            ...
            if (typeof zohouser.DC_INFO != "undefined") {
              ...
              if (customvar.domainArr[0].length == h(".infoload").length) {
                ...
                ao.src =
                  "https://accounts." + P + "." + dcdomainOne + "/u/info";
            ...
            if (
              w == h(".infoload").length &&
              customvar.domainArr[1].length == 0
            ) {
              ...
              for (var ap in aq) {
                if (typeof aq[ap].countries != "undefind") {
                  if (aq[ap].countries.indexOf(CountryCode) > -1) {
                    if (
                      aq[ap].notavailable.indexOf(customvar.productName) > -1
                    ) {
                      dcdomainOne = "com";
                      onlycom = true;
                    } else {
        ...
        if (window.location.hostname != "www.zohohelp.com") {
          r.src =
            "https://accounts." + ZdomainName + "." + domainOne + "/u/info";
    ...
    var x = "/policy.html ";
    var H = "";
    var R = "//www.facebook.com/zoho";
    var ah = "//twitter.com/zoho";
    var N =
    ...
    if (currentUrlLang == "jp") {
      ...
      ad = "//www.zoho.com/jp";
      Y = "ofservice";
      an = "//www.zoho.com/jp/PrivacyPolicy.html";
      ae = "policy";
      x = "https://www.zoho.com/jp/policy.html";
      H =
        "<li><a href='//www.zoho.com/jp/refund.html'>&#12458;&#12531;&#12521;&#12452;&#12531;&#27770;&#28168;&#24460;&#12398;&#12461;&#12515;&#12531;&#12475;&#12523;&#12395;&#12388;&#12356;&#12390;</a></li>";
      R = "//www.facebook.com/zohoJapan";
      ah = "//twitter.com/jpzoho";
      N = "";
      X = "https://www.zoho.com/jp/contactus.html";
    } else {
      if (currentUrlLang == "de") {
    ...
    if (currentUrlLang == "jp") {
      Q =
        ...
        '">' +
        Drupal.t("Privacy Policy") +
        '</a></li><li class="cookie-policy"><a href="https://www.zoho.com/privacy/cookie-policy.html">' +
        Drupal.t("Cookie Policy") +
        '</a></li><li><a href="' +
        s +
        '" class="gdprc">' +
    ...
    var G =
      ...
      '">' +
      U +
      '</a></li><li class="zglob-lang"><div class="ZF-dlsel"><div class="zdc-container"><span class="zdc-text">Select DC</span><div class="zdc-container-inner"><ul><li><a href="https://www.zoho.in/">IN DC</a></li><li><a href="https://www.zoho.com/">US DC</a></li><li><a href="https://www.zoho.eu/">EU DC</a></li></ul></div></div></div></li></ul></div></div></div>' +
      Q;
    var G = Q;
    newFooter = Q;
    aj();
    ...
    h(window).scroll(function () {
      ...
      if (h(".zlang-container").children(".zlang-container-inner").length > 0) {
        h(".zlang-container")
          .children(".zlang-container-inner")
          .removeClass("show")
          .addClass("hide");
      }
      Z();
    ...
    h(".menu-icon").click(function () {
      ...
      if (m == false) {
        ...
        setTimeout(function () {
          h(".mobile-menu").css({ left: "0%" });
          var ao =
            parseInt(window.innerHeight) - parseInt(h(".header").height());
          h(".mobile-menu").css({ height: ao + "px" });
        }, 100);
        setTimeout(function () {
          h("html,body").css({ overflow: "hidden" });
        }, 0);
      } else {
        ac();
      }
    ...
    h(".userinfo-container").css({ display: "block" });
    ...
    h("body").click(function (ar) {
      ...
      if (
        productName == "mail" &&
        h(".signup-box form").css("display") == "none"
      ) {
        ap = false;
      } else {
        if (
          _lhref.indexOf("/creator/apps/") > 0 ||
          h(ar.target).hasClass("scrollstop")
        ) {
          ap = false;
        }
      }
      ...
      if (ar.target.parentNode) {
        ar.target.parentNode.parentNode != null
          ? (at = ar.target.parentNode.parentNode.className)
          : "";
        ar.target.parentNode.className != null
          ? (aq = ar.target.parentNode.className)
          : "";
      }
      ...
      if (window.location.href.indexOf("crm/what-is-crm.html") < 0 && ap) {
        if (
          ao == "signup" ||
          aq == "get-started" ||
          (h(ar.target).hasClass("act-btn") &&
            h(ar.target).hasClass("cta-btn") &&
            !h(ar.target).hasClass("zwp-pricing-link")) ||
          h(ar.target).hasClass("zgh-signup")
        ) {
          if (window.innerWidth > 991) {
            if (
              h(".signup-box .sgfrm").length != 0 &&
              h(".zp-home-right").css("display") != "none" &&
          ...
          if (
            h(".signup-box #czone-wallet").length > 0 &&
            h(".form-wrap .creditelm").length > 0
          ) {
            ar.preventDefault();
            if (getusername) {
              h("html, body").animate(
      ...
      if (ar.target.className == "menu") {
        ...
        if (ar.target.className == "mobile-menu-icon") {
          ...
          h(".product-nav-links .menu").css({
            height:
              window.innerHeight - h("#mini-panel-product_menu").outerHeight(),
          });
          if (F == false) {
            h(".zgh-accounts .zgh-signup").fadeOut(100);
            h(".menu").slideDown(300);
            h("body").css({ overflow: "hidden" });
            h(".product-nav-links .menu").css({ overflow: "scroll" });
          } else {
      ...
      if (at == "userinfo-details") {
        ...
        if (getWidth > 285) {
          h(".userinfo-details").css({ width: "35px", height: "35px" });
          h(
    ...
    var o = true;
    var E = 200;
    h(".dropdown-mask").css({ height: "200px" });
    h(".header .menu >  li").hover(
      function (ap) {
        $this = h(this);
        var ao = ap.clientX;
    ...
    function Z(ao) {
      h(".userinfo-details").removeClass("zoho-expand");
      if (ao > 285) {
        h(".userinfo-details").css({ width: 35, height: 35 });
        h(
          ".product-header-top .userinfo-details, .product-header-top .userinfo-container"
        ).css({ height: "43px" });
      }
      if (h(window).scrollTop() > 200) {
        ...
        h(".product-header-top").css({ overflow: "visible" });
      } else {
        h(".product-header-top").addClass("slide");
        h(".product-header-top").css({ overflow: "hidden" });
      }
    }
    h(window).resize(function () {
      if (h(".footer-search-input").length > 0) {
        if (window.innerWidth <= 767) {
          h(".footer-search-input").attr(
            "placeholder",
            Drupal.t("Search") + " zoho." + domainOne
          );
        } else {
          h(".footer-search-input").attr(
            "placeholder",
      ...
      if (h(window).outerWidth() <= 767) {
        ...
        h(".product-nav-links .menu .featured-apps-part").css(
          "display",
          "block"
        );
        h("#mini-panel-product_menu .zlang-container").show();
        if (
          h("#mini-panel-product_menu .zlang-container").length < 1 &&
          h(".header .zlang-container").length != 0
        ) {
          var ao =
            '<div class="zlang-container">' +
            h(".header .zlang-container").html() +
            "</div>";
        ...
        h(
          ".product-header-inner .userinfo-container,.product-header-inner .goto-link"
        ).remove();
        h(".product-nav-links .menu .featured-apps-part").css(
          "display",
          "none"
    ...
    function ab() {
      if (window.innerWidth < 768) {
        h(".mobile-menu-icon").css({ display: "block" });
        if (!h(".mobile-menu-icon .hamburger-box").hasClass("active")) {
          h("#header .menu").css({ display: "none" });
        }
      } else {
        h(".mobile-menu-icon").css({ display: "none" });
        h("#header .menu").css({ display: "block" });
      }
    ...
    function M() {
      if (jQuery("body").hasClass("og-context-node-3434")) {
        if (jQuery("body").hasClass("node-type-product-help")) {
          jQuery(".menu-panel .zoho-parent-wrapper .hasChild ").each(function (
            ap,
            ar
          ) {
            if (ap == 0) {
              var aq = jQuery(this)
                .find(".zoho-child-wrapper li a")
                .eq(1)
                .text();
              if (aq == "Onboarding") {
      ...
      if (ao) {
        ...
        if (ap.length == 3) {
          jQuery(".bottom-promo .ct-action-btn").attr(
            "href",
            "/crm/lp/signup.html?plan=enterprise?src=" + ap[2] + ""
          );
        } else {
          if (ap.length > 3) {
            jQuery(".bottom-promo .ct-action-btn").attr(
              "href",
              "/crm/lp/signup.html?plan=enterprise?src=" +
                ap[2] +
                "/" +
                ap[3] +
                ""
    ...
    function L() {
      ...
      if (getAllField.length != 0) {
        h(".signup-box form").eq(0).css({ opacity: "0" });
        setTimeout(function () {
          h(".signup-box form").eq(0).animate({ opacity: "1" });
        }, 1000);
        if (h(".signup-box").hasClass("buttomsignup")) {
          ...
          h("html, body").animate({ scrollTop: 0 }, 1000, function () {
            setTimeout(function () {
              h(".focusin").removeClass("focusin");
            }, 500);
          });
        ...
        setTimeout(function () {
          ...
          ao.length > 1
            ? ao.eq(1).addClass("focusin").focus()
            : ao.eq(0).addClass("focusin").focus();
        }, 2000);
      }
    }
    function A() {
    ...
    function aj() {
      ...
      if (!getusername) {
        ...
        if (typeof ap != "undefined" && typeof ap != "") {
          var at = "";
          currentLang != ""
            ? (at = "service_language=" + currentLang + "&")
            : (at = "");
          aw =
      ...
      if (!customvar.customclean) {
        if (window.innerWidth > 992 && window.innerHeight < 800) {
          if (h(".testimonial-content").length > 0) {
            ...
            h(".testimonial-content").css(
              "margin-top",
              (window.innerHeight - 20 - ao) / 2
            );
          }
        }
        ...
        if (getusername) {
          ...
          if (
            h(".zh-access").length > 0 &&
            h("body").hasClass("node-type-zoho-home")
          ) {
            h(".zh-access").attr(
              "href",
              "https://home." + Zdomain + "." + dcdomainOne + "/home"
            );
          }
        }
        if (!getusername) {
          ...
          h(".try-now")
            .addClass("signupbtn-hide")
            .removeClass("signupbtn-show");
          var at = "/" + productName + "/";
          ...
          if (ar.indexOf(productName) < 0) {
            ...
            productName == "home"
              ? (aI = aI.split("/home")[0] + aI.split("/home")[1])
              : "";
            productName == "mail"
              ? (aI = langsrc + "mail/zohomail-pricing.html")
              : "";
          }
          if (ar.indexOf(productName) > -1) {
            if (productName == "crmplus") {
              ...
              if (productName == "crm") {
                ...
                if (
                  au != "/crm/index.html" &&
                  au != "/crm/zohocrm-pricing.html" &&
                  au != "/crm/comparison.html"
                ) {
          ...
          h(".header .signing .signin").css({ opacity: 1 });
          if (window.innerWidth <= 767) {
            h(".user-icon").css({ display: "block" });
          }
        }
        if (getusername) {
          if (!h("body").hasClass("zb-firefox")) {
            if (global_getUrlParam("zsrc") != "") {
              if (
                global_getUrlParam("zsrc").indexOf("fromproduct-remove") > -1
              ) {
                if (global_getUrlParam("serviceurl") != "") {
                  if (
                    ...
                    window.location =
                      ...
                      "." +
                      dcdomainOne +
                      decodeURIComponent(global_getUrlParam("serviceurl"));
                  } else {
                    window.location = customvar.dcadded(
                      global_getUrlParam("serviceurl")
                    );
                  }
                } else {
          ...
          if (h(".loggedin-userinfo").length > 0) {
            ...
            if (h(".access-apps").length < 1) {
              h(".loggedin-userinfo").append(
                " <h2 class='username'>" +
                  Drupal.t("Welcome") +
                  " <span>" +
                  customvar.htmlencode(getusername) +
                  "!</span></h2> <a class='access-apps' href=" +
                  $gotoPage +
                  "></a>"
              );
              h(".loggedin-userinfo .access-apps").html(
                accessZoho + " " + customvar.productName
              );
            }
          }
          if (!hidelogin) {
          ...
          if (customvar.servicename == "") {
            if (
              customvar.pServiceNames[
                customvar.pArr.indexOf(customvar.productName)
              ] != null &&
              customvar.pServiceNames[
                customvar.pArr.indexOf(customvar.productName)
              ] != "undefined"
          ...
          var az =
            ...
            customvar.service;
          var aG =
            "https://accounts." + Zdomain + "." + dcdomainOne + "/u/h#home";
          if (
            customvar.outproduct.indexOf(customvar.productName) > -1 ||
            window.location.host == "catalyst.zoho.eu"
          ) {
          ...
          $userAvator =
            "https://contacts.zoho.com/file?t=user&fs=thumb" + infocallzuid;
          var av =
            '<div class="zgh-user-box"> <div class="zgh-userPanel"> <img src=' +
            $userAvator +
            " alt=" +
            customvar.htmlencode(getusername) +
            ' class="zgh-userAvatar"> <div class="zgh-userLink"> <ul> <li class="zgh-userImage"> <img src=' +
            $userAvator +
            " alt=" +
            customvar.htmlencode(getusername) +
          ...
          var ax = setInterval(function () {
            if (h(".zw-product-header .zgh-accounts").length > 0) {
              ...
              h(".zgh-userAccess a").attr(
                "href",
                h(".act-btn.cta-btn").attr("href")
              );
          ...
          if (hidelogin) {
            ...
            var aC = h("body").attr("data-prdname-display")
              ? h("body").attr("data-prdname-display")
              : productName;
          ...
          if (
            typeof customvar.nonlogged == "undefined" &&
            h(".product-header-top .zgh-signup").length
          ) {
            if (
              !h(".product-header-top .zgh-signup")
                .attr("href")
                .includes(customvar.productName)
            ) {
              h(".product-header-top .zgh-signup").attr(
                "href",
                langsrc + "signup.html"
              );
            }
          ...
          h(
            ".product-header-top .zgh-accounts .zgh-signup, .zgh-accounts .zgh-login"
          ).css("display", "inline-block");
          h(".act-btn.cta-btn, .node-type-zoho-home .zh-signup").css({
            opacity: "1",
            visibility: "visible",
          });
          h(".product-header-top .zgh-accounts .zgh-login").css(
            "display",
            "none"
          );
        }
        h('a[href*="mailto:abuse@zoho.com"]')
        ...
        if (dcdomainOne == "eu") {
          h('a[href*="mailto:abuse@zoho.com"]')
            ...
            .attr("href", "mailto:abuse@zoho.com");
          h('a[href*="mailto:postmaster@zoho.com"]')
      ...
      setTimeout(function () {
        if (h(".signup-box").length > 0) {
          for (var ao = 0; ao < h(".sgfrm input").length; ao++) {
            if (
              h(".sgfrm input").eq(ao).val() != "undefined" &&
              h(".signup-box").css("display") == "block"
            ) {
    ...
    for (var ai = 0; ai < p.length; ai++) {
      W[ai] =
        jQuery(p[ai]).offset().top -
        window.innerHeight +
        jQuery(".features-list li").innerHeight();
    }
    ...
    jQuery("body").click(function (ao) {
      if (ao.target.className == "product-menu") {
      } else {
    ...
    jQuery(".bottom-signup,.signing .signup").click(function (ao) {
      ...
      ao.preventDefault();
      jQuery("html, body").animate({ scrollTop: 0 }, 1000, "easeInOutQuad");
      setTimeout(function () {
...
$(window).on("load", function () {
  ...
  if (k.indexOf(customvar.productName) < 0) {
    if (predomain) {
      $.getScript(
        customvar.ocmsprelink + "/sites/zweb/js/common/crmwebforms.js"
      );
    } else {
      $.getScript(
        "https://www.zohowebstatic.com/sites/zweb/js/common/crmwebforms.js"
      );
    }
  }
  var o = 0;
  var r = setInterval(function () {
    if (
      _preZ == window.location.hostname &&
      customvar.pathname == "/creator/footer-test.html"
    ) {
      if ($(".zw-footer-search-lang-block").length) {
        ...
        $(".zw-footer-search-lang-block").append(
          '<div class="zlang-container"><span class="zlang-text">' +
            ...
            '</span><div class="zlang-container-inner" style="display: none;"><ul><li><a class="nonlang-ld" data-lang="es-xl" href="">EspaÃ±ol</a></li><li><a class="nonlang-ld" data-lang="pt-br" href="">PortuguÃªs (Brasil)</a></li><li><a class="nonlang-ld" data-lang="de" href="">Deutsch</a></li><li><a class="nonlang-ld" data-lang="fr" href="">FranÃ§ais</a></li></ul></div></div>'
        );
        $(".zlang-text").show();
      ...
      if (
        ...
        if ($(".zgh-localBox ul").html() != "") {
          if ($(".zgh-localBox ul li").length > 0) {
            ...
            $(".zlang-container").on("click", function (t) {
              if (
                !$(this).children(".zlang-container-inner").hasClass("show")
              ) {
                $(this)
                  .children(".zlang-container-inner")
                  .removeClass("hide")
    ...
    if (customvar.newFooterProducts.includes(customvar.productName)) {
      $(".zw-footer-search-lang-block").prepend(
        '<div class="footer-search"> <form id="footer-search-action"> <input class="footer-search-input" aria-label="Search for product overviews, FAQs, and more..." autocomplete="off" placeholder="' +
          Drupal.t("Search for product overviews, FAQs, and more...") +
          '" type="text"> <button class="footer-search-btn" aria-label="footer-search-btn" type="submit" value="Submit"><span></span></button> </form></div>'
      );
    } else {
      $(".ZPprivacy").before(
        '<div class="footer-search"> <form id="footer-search-action"> <input class="footer-search-input" aria-label="Search for product overviews, FAQs, and more..." autocomplete="off" placeholder="' +
  ...
  $(document).on("submit", "#footer-search-action", function (v) {
    ...
    if (currentUrlLang == "") {
      if (
        ...
        u = "https://www.zoho.com/search-results.html";
      } else {
        u = window.location.origin + "/search-results.html";
      }
    } else {
      u =
        window.location.origin + "/" + currentUrlLang + "/search-results.html";
    }
    if (t != "") {
  ...
  for (var n = 0; n < l.length; n++) {
    if (
      l.eq(n).attr("href") != "undefined" &&
      l.eq(n).attr("href") != null &&
      l.eq(n).attr("href") != "" &&
      l.eq(n).attr("data-noneedopener") != ""
    ) {
      ...
      if (l.eq(n).attr("href").indexOf("forums.zoho.com") > -1) {
        l.eq(n).attr(
          "href",
          l
            .eq(n)
            .attr("href")
            .split("forums.zoho.com")
            .join("help.zoho.com/portal/en/community")
        );
      }
      if (currentUrlLang != "") {
        if (
          l.eq(n).attr("href").indexOf("/security.html") > 0 ||
          l.eq(n).attr("href").indexOf("/cookie-policy.html") > 0 ||
          l.eq(n).attr("href").indexOf("/ipr-complaints.html") > 0 ||
          l.eq(n).attr("href").indexOf("/compliance.html") > 0
        ) {
          if (
            currentUrlLang == "de" &&
            (l.eq(n).attr("href").indexOf("/security.html") > 0 ||
              l.eq(n).attr("href").indexOf("/privacy/cookie-policy.html") > 0)
          ) {
          } else {
            if (
              currentUrlLang == "pt-br" &&
              (l.eq(n).attr("href").indexOf("/security.html") > 0 ||
                l.eq(n).attr("href").indexOf("/privacy/cookie-policy.html") >
                  0 ||
                l.eq(n).attr("href").indexOf("/compliance.html") > 0)
            ) {
            } else {
...
function langStrip() {
  ...
  CountryCode.toLowerCase() == "br" || CountryCode.toLowerCase() == "pt"
    ? (p = "pt-br")
    : "";
  ...
  if (global_getUrlParam("zc_localredirection") != "") {
    ...
    for (redirectcode in localRedirectionlist) {
      if (typeof localRedirectionlist[redirectcode] != "undefined") {
        if (
          localRedirectionlist[redirectcode].split(",").indexOf(CountryCode) >
          -1
        ) {
          h = false;
        }
            ...
            if (p == "de") {
              $(".ztopstrip-container").append(
                '<div class="langstrip"><span class="langTxt">' +
                  bannertext[p].split(" ::: ")[1] +
                  '!</span><span class="langBtn">' +
                  bannertext[p].split(" ::: ")[0] +
                  '</span><span class="langClose">X</span></div>'
              );
            } else {
              $(".ztopstrip-container").append(
            ...
            if (CountryCode != "NL" || currentUrlLang != "nl") {
              if (CountryCode != "ID" && currentUrlLang != "id") {
                if (CountryCode != "DE" && currentUrlLang != "de") {
                  var h = false;
                  if (
                    typeof localRedirectionlist[currentUrlLang] != "undefined"
                  ) {
                    if (
                      localRedirectionlist[currentUrlLang]
                        .split(",")
          ...
          l.addEventListener("click", function () {
            ...
            if (currentUrlLang === "") {
              currentUrl = currentUrl.replace(
                ...
                window.location.host + "/" + gotoUrlLanguage
              );
            } else {
              currentUrl = currentUrl.replace(
                "/" + currentUrlLang + "/",
            ...
            let paramDelimiter = currentUrl.includes("?") ? "&" : "?";
            window.location.href = encodeURI(
              currentUrl + paramDelimiter + "zredirect=f&lb=" + gotoUrlLanguage
            );
            try {
              customvar.lsoinfo("zloaded", "1");
            } catch (q) {}
  ...
  if (
    ...
    if ($(".cookiestrip").length < 1) {
      ...
      if (!l) {
        if (currentUrlLang == "") {
          var k = Drupal.t(
            "We use cookies to help us understand and serve you better."
          );
          var m =
            window.location.host == "catalyst.zoho.eu"
...
$(document).ready(function (ag) {
  ...
  if (
    ...
    $(".header .logo, .header-part .logo").attr(
      "href",
      "https://www.zoho." + domainOne + langsrc
    );
  }
  ...
  if (langArr.indexOf(currentUrlLang) > -1) {
    ...
    for (var ad = 0; ad < W.length; ad++) {
      if (
        W.eq(ad).attr("href") != "undefined" &&
        W.eq(ad).attr("href") != null &&
        W.eq(ad).attr("href") != "" &&
        !W.eq(ad).attr("href").includes("/terms.html") &&
        !W.eq(ad).attr("href").includes("/privacy.html") &&
        !W.eq(ad).hasClass("czone-signup-term") &&
        !W.eq(ad).hasClass("zrlink") &&
        !W.eq(ad).parent().hasClass("footer-privacy") &&
        !W.eq(ad).parent().hasClass("footer-terms")
      ) {
        var I = W.eq(ad).attr("href").split("/").indexOf("help") < 0,
          ...
          G =
            "https://www.zoho.com/assist/lp/demo-registration.html?src=pricing-faq" !=
          ...
          ah =
            W.eq(ad)
              .attr("href")
              .indexOf("https://www.zoho.com/campaigns/contact-us.html") < 0,
          v =
            W.eq(ad)
              .attr("href")
              .indexOf("https://www.zoho.com/survey/education-discount.html") <
            0,
          H =
            W.eq(ad)
              .attr("href")
              .indexOf("https://www.zoho.com/developer/signup.html") < 0,
          al = W.eq(ad).attr("href").indexOf("reports/onpremise/eula.html") < 0,
          F =
            W.eq(ad).attr("href").indexOf("reports/onpremise/get-quote.html") <
            0,
          ...
          r =
            W.eq(ad)
              .attr("href")
              .indexOf("https://www.zoho.com/teamdrive/contact.html") < 0,
          z =
            W.eq(ad)
              .attr("href")
              .indexOf("https://www.zoho.com/workdrive/contact.html") < 0,
          Q = W.eq(ad).attr("href").indexOf("webinars.html") < 0,
          aj =
            W.eq(ad)
              .attr("href")
              .indexOf("analytics/onpremise/get-quote.html") < 0,
          p = W.eq(ad).attr("href").indexOf("/workdrive/contact.html") < 0,
          U = !0;
        "com.cn" == domainOne && (U = !1),
          "crm" != productName ||
            ("fr" != currentUrlLang &&
              "de" != currentUrlLang &&
        ...
        var q = W.eq(ad).attr("href").indexOf(".zip") < 0,
          ...
          L =
            W.eq(ad)
              .attr("href")
              .indexOf("creator/developers/find-a-developer.html") < 0,
          O =
            W.eq(ad)
              .attr("href")
              .indexOf("campaigns/email-marketing-demo.html") < 0,
          J =
            W.eq(ad)
              .attr("href")
              .indexOf("marketingautomation/marketing-automation-demo.html") <
            0,
          w = W.eq(ad).attr("href").indexOf("sign/legal-guide.html") < 0,
          T =
            W.eq(ad)
              .attr("href")
              .indexOf("marketingautomation/request-quote.html") < 0,
          ab = W.eq(ad).attr("href").indexOf(".rpm") < 0,
          u =
            W.eq(ad)
              .attr("href")
              .indexOf("schedule-your-instagram-posts-on-zoho-social.html") < 0,
          P = W.eq(ad).attr("href").indexOf("people/request-quote.html") < 0,
          Y =
            W.eq(ad)
              .attr("href")
              .indexOf("forms/integrations/zoho-campaigns.html") < 0,
        ...
        if (
          ...
          if (W.eq(ad).attr("href").split("/")[1] == productName) {
            ...
            if (W.eq(ad).attr("href").split("/")[2] == "www.zoho.com") {
              if (
                allProductlowerCase.indexOf(
                  W.eq(ad).attr("href").split("/")[3]
                ) > -1
              ) {
                var m = encodeURI(
                  "https://www.zoho.com/" +
                    currentUrlLang +
                    W.eq(ad).attr("href").split("www.zoho.com")[1]
                );
                W.eq(ad).attr("href", m);
              }
            } else {
              if (W.eq(ad).attr("href").split("/")[2] == "www.zoho.com") {
                ...
                if (
                  ...
                  if (W.eq(ad).attr("href") == "/security.html") {
                    var m = encodeURI(
                      "/" + currentUrlLang + W.eq(ad).attr("href")
                    );
                    W.eq(ad).attr("href", m);
                  }
                }
        ...
        if (
          W.eq(ad).attr("href").indexOf("help/") > -1 ||
          W.eq(ad).attr("href").indexOf("blog") > -1
        ) {
          if (currentUrlLang != "jp") {
  ...
  var h = setTimeout(function () {
    if ($(".zgdprform-countrylist-container").length > 0) {
      ...
      if (window.location.host == _preZ) {
        ...
        j.src =
          "https://www.zohowebstatic.com/sites/zweb/js/common/gdprcompliance.js";
      }
...
function CheckelEmentSignup() {
  var h = setTimeout(function () {
    if ($(".signup-box form").length > 0) {
      if ($(".za-captcha-container").length > 0) {
        ...
        if ($(".za-newsletter-container").length > 0) {
          $(".za-newsletter-container").html(
            '<label for="newsletter" class="news-signup sign_agree"> <input tabindex="1" class="za-newsletter" type="checkbox" id="newsletter" name="newsletter" value="true" onclick="toggleNewsletterField()"> <span class="icon-medium" id="signup-newsletter"></span> <span>' +
              _txtIwould +
              "</span> </label>"
          );
          $(".za-newsletter-container").css("display", "none");
          if (
            window.location.href.indexOf("mdm-cloud.html") > 0 &&
            window.location.host == _preZ
          ) {
      ...
      j.type = "text/javascript";
      j.src =
        "https://www.zohowebstatic.com/sites/zweb/js/common/gdpr-compliance-signup.js";
      if (window.location.host == _preZ) {
        j.src =
          "https://" +
          _preZ +
          "/sites/zweb/js/common/gdpr-compliance-signup.js";
      }
      document.getElementsByTagName("head")[0].appendChild(j);
      clearInterval(h);
    } else {
...
$(document).on(
  "click",
  ".umain .cta-btn.logged-in, .userinfo-details .userinfo-access",
  function (h) {
...
$(document).on("click", ".vimvideo", function (j) {
  ...
  var h =
    (k.indexOf("?") > 0 ? "&" : "?") +
    (k.indexOf("autopause=1") > 0 ? "" : "autopause=1&") +
    (k.indexOf("dnt=1") > 0 ? "" : "dnt=1&") +
    (k.indexOf("autoplay=1") > 0 ? "" : "autoplay=1") +
    '"width="3840"height="2160"frameborder="0"allow="autoplay;fullscreen;picture-in-picture"allowfullscreentitle="1-video.mp4';
  $(".zvim-zc-video-box").append(
    '<iframe src="' +
      k +
      h +
      '" class="zc-video-iframe"></iframe><div class="zvim-share-icon"><div class="zvim-share-button" title="Share"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 159.35 197.17" class="share-icon"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M152.53,118.26a6.81,6.81,0,0,0-6.81,6.82v40.51a18,18,0,0,1-17.94,17.94H31.58a18,18,0,0,1-17.95-17.94V69.39A18,18,0,0,1,31.58,51.45h94.85L97.64,80.63a6.81,6.81,0,0,0,4.85,11.6,6.75,6.75,0,0,0,4.85-2l40.8-41.34a6.81,6.81,0,0,0-.26-9.82L107.09,1.78a6.82,6.82,0,0,0-9.2,10.07l28.44,26H31.58A31.62,31.62,0,0,0,0,69.39v96.2a31.62,31.62,0,0,0,31.58,31.58h96.2a31.61,31.61,0,0,0,31.57-31.58V125.08A6.82,6.82,0,0,0,152.53,118.26Z" fill="#fff"></path></g></g></svg> </svg></div></div><div class="zvim-popup-share-overlay-wrapper"><div class="zvim-overlay-bg"></div><div class="zvim-popup-share-overlay-cell"> <section class="zvim-popup-share-section"><ul class="zvim-share-list"><li class="zvim-share-list-item"> <a class="zvim-share-twitter" href="https://twitter.com/intent/tweet?url=https://youtube.com/watch?v=' +
      vidDataUrl +
      '" rel="noopener" target="_blank" role="button"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><defs></defs><path fill="#1da1f2" d="M512 97.248c-19.04 8.352-39.328 13.888-60.48 16.576 21.76-12.992 38.368-33.408 46.176-58.016-20.288 12.096-42.688 20.64-66.56 25.408C411.872 60.704 384.416 48 354.464 48c-58.112 0-104.896 47.168-104.896 104.992 0 8.32.704 16.32 2.432 23.936-87.264-4.256-164.48-46.08-216.352-109.792-9.056 15.712-14.368 33.696-14.368 53.056 0 36.352 18.72 68.576 46.624 87.232-16.864-.32-33.408-5.216-47.424-12.928v1.152c0 51.008 36.384 93.376 84.096 103.136-8.544 2.336-17.856 3.456-27.52 3.456-6.72 0-13.504-.384-19.872-1.792 13.6 41.568 52.192 72.128 98.08 73.12-35.712 27.936-81.056 44.768-130.144 44.768-8.608 0-16.864-.384-25.12-1.44C46.496 446.88 101.6 464 161.024 464c193.152 0 298.752-160 298.752-298.688 0-4.64-.16-9.12-.384-13.568 20.832-14.784 38.336-33.248 52.608-54.496z"></path></svg> </a></li><li class="zvim-share-list-item"> <a class="zvim-share-facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://youtube.com/watch?v=' +
      vidDataUrl +
      '" rel="noopener" target="_blank" role="button"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs></defs><path fill="#0a66c2" d="M15.997 3.985h2.191V.169C17.81.117 16.51 0 14.996 0c-3.159 0-5.323 1.987-5.323 5.639V9H6.187v4.266h3.486V24h4.274V13.267h3.345l.531-4.266h-3.877V6.062c.001-1.233.333-2.077 2.051-2.077z"></path></svg> </a></li><li class="zvim-share-list-item"> <a class="zvim-share-linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A//youtu.be/' +
      vidDataUrl +
...
$(document).on(
  "click",
  ".zvim-model, .zvim-zc-video-box, .zvim-share-button, .zvim-share-close, .zvim-share-list-item",
  function (j) {
    j.stopPropagation();
        ...
        if ($(this).attr("class") == "zvim-share-close") {
          ...
          if ($(this).attr("class") == "zvim-share-list-item") {
            ...
            window.open(
              h + vidDataUrl,
              "Share Zoho",
              "height=500,width=800,resizable=1"
            );
          }
        }
      }
...
$(document).on("click", ".nonvimvideo", function (j) {
  j.stopPropagation();
  if (
    typeof $(this).attr("data-iframe") != "undefined" ||
    typeof $(this).attr("data-video") != "undefined"
  ) {
    $("body").prepend(
      '<div class="zc-video-modal"><a href="javascript:;" class="zc-video-close"></a><div class="zc-video-modalInner"><div class="zc-video-container"><div class="zc-video-box"><div id="muteYouTubeVideoPlayer" class="zc-video-iframe"></div></div></div></div></div>'
    );
    var h =
      typeof $(this).attr("data-video") != "undefined"
    ...
    if (currentUrlLang != "jp" || !excludearr.includes(customvar.productName)) {
      ...
      if ($(".load-header").length <= 0 && !_lhref.includes("com/press.html")) {
        ...
        if (predomain) {
          newzchf.src =
            customvar.ocmsprelink +
            "/sites/zweb/js/common/zc-headerfooter-v2.js";
        } else {
          if (window.location.hostname == _preZ) {
            newzchf.src = "/sites/zweb/js/common/zc-headerfooter-v2.js";
          } else {
            newzchf.src =
              "https://www.zohowebstatic.com/sites/zweb/js/common/zc-headerfooter-v2.js";
          }
        }
...
if ($(".zoholics-global-container").length > 0) {
  ...
  if (predomain) {
    zoholics_global.src =
      customvar.ocmsprelink + "/sites/zweb/js/common/zoholics-banner.js";
  } else {
    zoholics_global.src =
      "https://www.zohowebstatic.com/sites/zweb/js/common/zoholics-banner.js";
  }
  document.getElementsByTagName("head")[0].appendChild(zoholics_global);
}
if (
  $(".zpricegroup-common").length > 0 ||
  $(".zpricegroup-common-sl").length > 0
) {
  ...
  if (predomain) {
    ...
    zcprice.src =
      "https://www.zohowebstatic.com/sites/zweb/js/common/zc-pricing.js";
  }
...
function zcPriInit(k) {
  if (!document.getElementById("zc-script-pricing")) {
    ...
    if (getDomain == _preZ || getDomain == _preZC || getDomain == _zcmsZC) {
      ...
      h.src =
        "https://www.zohowebstatic.com/sites/zweb/js/common/zc-dynamic-pricing.js";
    }
    ...
    if (
      typeof zpSetPricingInfo !== "undefined" ||
      typeof zpSetPricingInfo === "function"
    ) {
      k();
    } else {
...
if (
  ...
  if (predomain) {
    transjs.src =
      customvar.ocmsprelink + "/sites/zweb/js/common/transfeedback.js";
  } else {
    transjs.src =
      "https://www.zohowebstatic.com/sites/zweb/js/common/transfeedback.js";
  }
  ...
  if (predomain) {
    transcss.href =
      customvar.ocmsprelink + "/sites/zweb/css/common/transfeedback.css";
  } else {
    transcss.href =
      "https://www.zohowebstatic.com/sites/zweb/css/common/transfeedback.css";
  }
...
if (window.location.hostname == _preZ) {
  $("body").on("mousewheel DOMMouseScroll", function (h) {
    if ($("body").attr("scrolled") != "1" && customvar.singlescroll) {
      if (
        typeof h.originalEvent.detail == "number" &&
        h.originalEvent.detail !== 0
      ) {
      ...
      customvar.sscount > customvar.maxcount
        ? (customvar.sscount = customvar.maxcount)
        : "";
...
jQuery(document).ready(function () {
  if (
    fromSearch != "" &&
    fromSearch == 1 &&
    $("body").hasClass("node-type-just-html")
  ) {
...
function getLazSrc(n, h, m, k, l, j) {
  if (
    typeof n.attr("data-screen") !== typeof undefined &&
    n.attr("data-screen") !== false
  ) {
...
function setLazImgSrc(m, l, j, k, h) {
  if (l == 1) {
    for (g = 0; g < j.length; g++) {
      var n = $(j[g]);
      if (
        typeof n.attr("data-srcset") !== typeof undefined &&
        n.attr("data-srcset") !== false
      ) {
  ...
  if (q.length) {
    for (a = 0; a < q.length; a++) {
      ...
      if (thatObjOff >= 1 || objIsHid == "true" || objIsHid == "child") {
        if (
          (v == 1 && thatObjOff <= t.height() * 2) ||
          (v == 0 && s + t.height() * 2 >= thatObjOff)
        ) {
                ...
                if (r.length) {
                  for (f = 0; f < r.length; f++) {
                    if (
                      ...
                      if (
                        typeof $(r[f]).attr("data-src") !== typeof undefined &&
                        $(r[f]).attr("data-src") !== false
                      ) {
                        $(r[f]).css(
                          "background-image",
                          "url(" + $($(r[f])).attr("data-src") + ")"
                        );
...
if (getDomain != "www.zoho.com" && getDomain != "www.zoho.com.cn") {
  if (window.location.search.indexOf("hrLines") > 0) {
    ...
    $("body").append(
      '<div class="zwe-hrLine-box"><div class="zwe-hrLine-inner"></div></div>'
    );
    colLineCount = window.location.search.slice(9);
    if (colLineCount.split("/").length == 2) {
      if (
        colLineCount.split("/")[1] == "top" ||
        colLineCount.split("/")[1] == "bottom"
      ) {
    ...
    if (window.location.search.indexOf("hrLines") > 0) {
      ...
      if (colLineCount.split("/").length == 2) {
        if (colLineCount.split("/")[1] == "top") {
          $(".zwe-hrLine-inner .zwe-hrLine-static").css(
            "top",
            Number(colLineCount.split("/")[0])
          );
        } else {
          if (colLineCount.split("/")[1] == "bottom") {
            $(".zwe-hrLine-inner .zwe-hrLine-static").css(
              "top",
              j - Number(colLineCount.split("/")[0])
            );
          }
        }
      }
        ...
        if (
          ...
          if (r != "") {
            if (r.length <= 2 && r <= defColLineCount) {
              ...
              if (
                r.length >= 3 &&
                (r.endsWith("top") || r.endsWith("bottom"))
              ) {
                ...
                if (
                  ...
                  if (
                    s == 1 ||
                    (s == 0 &&
                      q + (j / zElmOffsetTotalRow) * zElmOffsetRow >= k)
                  ) {
                    zScrollOnPos(m, h);
                  }
                } else {
                    ...
                    for (b = 0; b < r.split(",").length; b++) {
                      ...
                      if (zElmOffsetRow.split("/").length == 2) {
                        ...
                        if (zElmOffsetRes.split("-").length == 1) {
                          if (
                            zElmOffsetTotalRows == "top" ||
                            zElmOffsetTotalRows == "bottom"
                          ) {
                            if (zElmOffsetTotalRows == "top") {
                              if (
                                o >= zElmOffsetRes.split("-")[0] &&
                                (s == 1 || (s == 0 && q + zElmOffsetRows >= k))
                              ) {
                                zScrollOnPos(m, h);
                              }
                            } else {
                        ...
                        if (zElmOffsetRes.split("-").length == 1) {
                          if (
                            ...
                            (s == 1 ||
                              (s == 0 &&
                                q + (j / defColLineCount) * zElmOffsetRow >= k))
                          ) {
                            zScrollOnPos(m, h);
                          }
                        } else {
...
customvar.scountrys =
  customvar.countries[1].indexOf(CountryCode) > -1 ? CountryCode : "US";
...
customvar.onlyletters = Drupal.t(
...
customvar.numcharspl = Drupal.t(
  "Only letters, numbers, underscores (_), dots (.) are allowed"
);
customvar.eLastName = Drupal.t("Please enter your last name");
...
customvar.registernum = Drupal.t(
  "Please enter your university register number"
);
...
customvar.creditsInfo =
  $(".signup-box").attr("creditsInfo") == undefined ? "false" : "true";
...
customvar.zwProTerms =
  customvar.zwProTerms != undefined ? "/" + customvar.zwProTerms : "";
if (customvar.couponCode == "") {
  customvar.couponCode = $(".signup-box").attr("data-couponcode");
}
customvar.getWalletAttributes = function (h) {
  if (
    customvar.dataredirectUrl == "" ||
    customvar.dataredirectUrl == undefined
  ) {
    customvar.redirectUrlLink =
...
customvar.walletcreditelm = function (k) {
  ...
  $(".form-wrap").append(
    '<div class="creditelm"> <div><input id="couponmail" class="sgnemail form-input" disabled="true" type="text" value="" placeholder="' +
      ...
      " : </b>" +
      Drupal.t(
        "Please be informed that you will receive credits in the above mentioned Zoho account only."
      ) +
  ...
  if (
    ...
    $(".form-wrap .signup-box .signupcontainer").append(
      "<input type='hidden' name='x_accountType' value='2'>"
    );
  }
  ...
  if (!customvar.redirectUrlLink) {
    customvar.redirectUrlLink = customvar.dcadded(
      customvar.signupObj.serviceurl
    );
  }
  var j =
    "https://store." +
...
customvar.mandatestart = function () {
  for (var j = 0; j <= $(".czone-dc input").length; j++) {
    if (
      $(".czone-dc .signupcontainer input").eq(j).attr("mandate") != "false"
    ) {
      if ($("#czone-home").length > 0) {
        if (
          typeof $(".czone-dc .signupcontainer input")
            .eq(j)
            .attr("placeholder") != "undefined"
        ) {
          var h = $(".czone-dc .signupcontainer input")
            .eq(j)
            .attr("placeholder");
          if (h.indexOf("*") < 1) {
...
customvar.newsletterhandle = function () {
  if (
    $(".globalcountrycode-signup option:selected").attr("newsletter_mode") > 1
  ) {
    $(".za-newsletter-container").addClass("zshow");
  ...
  if (
    $(".globalcountrycode-signup option:selected").attr("newsletter_mode") >= 2
  ) {
    $(".za-newsletter-container").removeAttr("style");
  }
  if (
    countryEu.indexOf(customvar.scountrys) > -1 ||
    customvar.scountrys == "AU" ||
    customvar.scountrys == "ZA"
  ) {
    $(".za-newsletter-container").addClass("zshow");
    $(".icon-medium").removeClass("checked").addClass("unchecked");
    $("#signupform [name='newsletter']").removeAttr("checked");
  ...
  if (
    customvar.scountrys == "SG" &&
    customvar.singaporeConsentproductList.includes(customvar.productName)
  ) {
...
function z_add_account_script_common() {
  ...
  if (customvar.outproduct.indexOf(customvar.productName) > -1) {
    p.src =
      "https://accounts." +
      (location.host.indexOf("localbigin") > 0 ||
      location.host.indexOf("localqntrl") > 0
        ? Zdomain
        : Zdomain) +
      "." +
      dcdomainOne +
  ...
  if (
    ...
    customvar.productName == "learn" &&
    _lhref.includes("/signup.html")
  ) {
    p.src =
      "https://accounts-alpha." +
      _lz +
      ".com/register/script?mode=33&temp_redirect=true&" +
      customvar.clang +
      "load_country=false&servicename=" +
      ($(".signup-box #coupon.x_r_coupon").length > 0
        ? "ZohoPayments"
    ...
    if (customvar.OTP_based()) {
      if ($(".signup-box .za-rmobile-container").length < 1) {
        if ($(".signup-box .mobile-container").length > 0) {
          $(".signup-box .mobile-container").before(
            customvar.signupflow.rmobile
          );
        } else {
          $(".signup-box .za-captcha-container").before(
            customvar.signupflow.rmobile
          );
        }
        if (typeof customvar.signupObj.rmobilelabel != "undefined") {
          if ($(".signup-box .za-rmobile-container").length > 0) {
            $(".signup-box .za-rmobile-container").prepend(
              customvar.signupObj.rmobilelabel
            );
          }
        }
        if (typeof customvar.signupObj.rplaceholder != "undefined") {
          if ($(".signup-box #rmobile").length > 0) {
            $(".signup-box #rmobile").attr(
              "placeholder",
              customvar.signupObj.rplaceholder
            );
          }
        }
      }
      ...
      if (global_getValParam("mode", p.src) == "") {
        ...
        if (global_getValParam("mode", p.src) != "24") {
          p.src = p.src
            .split("mode=" + global_getValParam("mode", p.src))
            .join("mode=24");
        }
      }
    } else {
  ...
  if (p.src.indexOf("mode=24") > -1) {
    if (
      $(".signup-box .za-rmobile-container").length > 0 &&
      $(".mobile-container").length < 1
    ) {
      if (
  ...
  if ($(".dc-info").length < 1) {
    ...
    if (currentUrlLang == "jp") {
      ...
      if (customvar.scountrys == "ES" && currentUrlLang == "es-xl") {
        ...
        if (
          (customvar.scountrys == "NL" || customvar.scountrys == "AN") &&
          currentUrlLang == "nl"
        ) {
...
function statehandling(h) {
  ...
  for (var j = 0; j < customvar.usstates.length; j++) {
    k +=
      '<option value="' +
      customvar.usstates[j].toLowerCase() +
      '">' +
      customvar.usstates[j] +
      "</option>";
  }
  ...
  for (
    ...
    if (
      ...
      var h = $(
        ...
        .eq(j)
        .attr("id");
      customvar.nSignupArr[customvar.nOfSignup][j] =
        h +
        "::to::" +
        $(
          '.signup-box input[type="text"], .signup-box input[type="tel"], .signup-box input[type="email"]'
          ...
          .eq(j)
          .val();
      customvar.validatetextArry[customvar.nOfSignup][j] = $("#" + h)
        .siblings(".placetxt")
        .attr("class");
    }
  }
  if ($("span.portal-input").length > 0) {
    customvar.nSignupspanArr[customvar.nOfSignup][0] =
      $("span.portal-input").html();
  }
  if ($(".za_country_code").length > 0) {
    customvar.nSignupdialArr[customvar.nOfSignup][0] =
      $(".za_country_code").val();
  }
  if ($(".za_confirm_country_code").length > 0) {
    customvar.nSignupconfirmdialArr[customvar.nOfSignup][0] = $(
      ".za_confirm_country_code"
    ).val();
  }
  if ($(".signup-box .rmobilevalue").length > 0) {
    customvar.hiddenrmobileval[customvar.nOfSignup] = $(
      ".signup-box .rmobilevalue"
    ).val();
  }
...
customvar.setsfield = function () {
  for (var k = 0; k < customvar.nSignupArr[customvar.nOfSignup].length; k++) {
    if (customvar.nSignupArr[customvar.nOfSignup][k] != "") {
      if (typeof customvar.nSignupArr[customvar.nOfSignup][k] != "undefined") {
        ...
        $("#" + j)
          .siblings(".placetxt")
          .addClass(customvar.validatetextArry[customvar.nOfSignup][k]);
      }
    }
  }
  if ($("span.portal-input").length > 0) {
    if (
      typeof customvar.nSignupspanArr[customvar.nOfSignup][0] != "undefined"
    ) {
      $("span.portal-input").html(
        customvar.nSignupspanArr[customvar.nOfSignup][0]
      );
  ...
  if (customvar.slectedradio[0] != "") {
    ...
    if ($('.signup-box input[name="x_optioncheck"]').length > 0) {
      $('.signup-box input[name="x_optioncheck"]').val(
        customvar.slectedradio[1]
      );
    }
  }
  customvar.showdcode();
...
customvar.getmadate = function (h) {
  ...
  return typeof $("input[name='" + h + "']").attr("mandate") != "undefined"
    ? $("input[name='" + h + "']").attr("mandate") == "false"
      ? false
      : true
    : true;
};
  ...
  (customvar.nscountrypop = function (h) {
    ...
    setTimeout(function () {
      ...
      if (h == "dial") {
        ...
        $(".ccodediv, .cccodediv").html(
          "+" + $(".za_country_code option:selected").attr("dialling_code")
        );
        if ($(".confirm_ccodediv").length > 0) {
          if (
            $(".confirm_phone_countrycode").length > 0 &&
            $(".za_confirm_country_code").length > 0
          ) {
            $(".confirm_phone_countrycode").val(
              "+" +
                $(".za_confirm_country_code option:selected").attr(
                  "dialling_code"
                )
            );
          }
  ...
  if ($("#emailmoile").length > 0) {
    if (/^\d+$/.test($("#emailmoile").val())) {
      if ($("#emailmoile").val().length > 2) {
        $("#emailmoile")
          .siblings(".za-country_code-container")
          .css("display", "block");
...
$(document).on(
  "keyup",
  '.za-password-container [name="password"]',
  function (o) {
    ...
    if (!j.includes(o.keyCode)) {
      ...
      if (o.target.value.length >= k) {
        var h = 1;
        /[A-Z]/.test(o.target.value) && h++,
          /[a-z]/.test(o.target.value) && h++,
          /\d/.test(o.target.value) && h++,
          /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(o.target.value) &&
            h++;
        n.css("width", h * 8 + 60 + "%");
...
$(document).on(
  "keyup",
  ".signup-box .za-rmobile-container #rmobile",
  function () {
    var h = $(this).val();
...
$(document).on("blur", ".signup-box input", function () {
  ...
  setTimeout(function () {
    if (h.parent().hasClass("field-error") || h.val() == "") {
      h.siblings(".placetxt")
        .removeClass("zcr-msg-active")
        .addClass("zcr-msg-grey");
    } else {
      h.siblings(".placetxt")
        .removeClass("zcr-msg-grey")
        .addClass("zcr-msg-active");
    }
    if (window.location.host == _preZ) {
...
function addsignup(l) {
  ...
  customvar.signupflow = {
    customelement:
      typeof customvar.signupObj.customelement != "undefined"
        ? customvar.signupObj.customelement
        : "",
    customelementone:
      typeof customvar.signupObj.customelementone != "undefined"
        ? customvar.signupObj.customelementone
        : "",
    customelementtwo:
      typeof customvar.signupObj.customelementtwo != "undefined"
        ? customvar.signupObj.customelementtwo
        : "",
    username:
      '<div class="username-container sgfrm" id="usernmediv"><div class="wrap-elm"><span class="placeholder">' +
      Drupal.t("Email Address") +
      '</span><input class="dummyclass" id="username" name="username" placeholder="' +
      Drupal.t("Email Address") +
      ...
      "</label></div></div>",
    name:
      '<div class="sgfrm za-name-container"><div class="wrap-elm"><span class="placeholder">' +
      Drupal.t("Name") +
      '</span><input class="dummyclass" id="name" name="firstname" placeholder="' +
      Drupal.t("Name") +
      '" type="text"></div></div>',
    fullname:
      '<div class="sgfrm za-name-container"><div class="wrap-elm"><span class="placeholder">' +
      customvar.fullName +
      '</span><input class="dummyclass" id="fullname" name="firstname" placeholder="' +
      customvar.fullName +
      '" type="text"></div></div>',
    email:
      '<div class="za-email-container sgfrm"><div class="wrap-elm"><span class="placeholder">' +
      customvar.email +
      '</span><input class="dummyclass" id="email" name="email" placeholder="' +
      customvar.email +
      '" type="text"></div></div>',
    password:
      '<div class="za-password-container sgfrm"><div class="wrap-elm"><span class="placeholder">' +
      customvar.password +
      '</span><span class="zpassword-show"></span><input class="dummyclass" id="password" name="password" placeholder="' +
      customvar.password +
      '" type="password">' +
      ...
      (typeof customvar.signupObj.password != "undefined"
        ? typeof customvar.signupObj.password.passwordstrength != "undefined"
          ? customvar.signupObj.password.passwordstrength == true ||
            ...
            ? '<div class="password-strengths zhide-common"> <p> Password Strength ï¼š<b class="weak-pass">Weak</b><b class="strong-pass">Strong</b></p> <div class="strengths-bar"> <span></span> </div> </div>'
            : ""
          : ""
        : "") +
      "</div></div>",
    repassword:
      '<div class="za-repassword-container sgfrm"><div class="wrap-elm"><span class="placeholder">' +
      Drupal.t("Confirm Password") +
      '</span><input class="dummyclass" id="repassword" name="repassword" placeholder="' +
      Drupal.t("Confirm Password") +
      '" type="password">' +
      (typeof customvar.signupObj.password != "undefined"
        ? typeof customvar.signupObj.password.showpassword != "undefined"
    ...
    companyname:
      ...
      '</span><input class="dummyclass" id="companyname" name="x_companyname" placeholder="' +
      customvar.companyName +
      '" type="text"></div></div>',
    contactnumber:
      '<div class="sgfrm mobile-container"><div class="wrap-elm"><span class="placeholder">' +
      customvar.phoneNumber +
      '</span><input class="dummyclass" id="mobile" type="text" placeholder="' +
      customvar.phoneNumber +
      '" name="r_address/1.phone"></div></div>',
    custominput:
      '<div class="sgfrm"><div class="wrap-elm"><span class="placeholder">' +
    ...
    dialcodecontactnumber:
      ...
      '</select><input id="dialcodecontactnumber" class="phone_countrycode" name="x_phone_countrycode" type="hidden" value=""><div class="ccodelabel" id="countryCodeDiv"><div class="ccodediv" id="ccodediv"></div></div><span class="dialphonenum placeholder">' +
      (typeof customvar.signupObj.dialcodecontactnumber != "undefined"
        ? typeof customvar.signupObj.dialcodecontactnumber.placeholder !=
          "undefined"
    ...
    redialcodecontactnumber:
      ...
      customvar.nscountrypop("dial") +
      '</select><input id="redialcodecontactnumber" class="confirm_phone_countrycode" name="x_confirm_phone_countrycode" type="hidden" value=""><div class="ccodelabel" id="countryconfirmCodeDiv"><div class="confirm_ccodediv" id="ccodediv"></div></div><span class="placeholder dialphonenum">' +
      (typeof customvar.signupObj.redialcodecontactnumber != "undefined"
        ? typeof customvar.signupObj.redialcodecontactnumber.placeholder !=
          "undefined"
      ...
      '" spellcheck="false" type="text" /> </div></div></div>',
    emailormobile:
      '<div class="sgfrm za-email-container" style="display:none"><span class="placeholder">' +
      customvar.email +
      ...
      customvar.nscountrypop("dial") +
      '</select><div class="ccodelabel" id="countryCodeDiv"><div class="ccodediv" id="ccodediv"></div></div></div><span class="placeholder">' +
      Drupal.t("Email") +
      " / " +
      Drupal.t("Phone") +
    ...
    rmobile:
      ...
      customvar.nscountrypop("dial") +
      '</select><input class="phone_countrycode" name="x_phone_countrycode" type="hidden" value="+91"><div class="ccodelabel" id="countryCodeDiv"><div class="ccodediv" id="ccodediv">+91</div></div><span class="dialphonenum placeholder">' +
      ...
      (typeof customvar.signupObj.dialcodecontactnumber != "undefined"
        ? typeof customvar.signupObj.dialcodecontactnumber.placeholder !=
          ...
          : customvar.phoneNumber
        : customvar.phoneNumber) +
      '" spellcheck="false" type="text" /> </div></div></div><input type="hidden" name="x_phone" value="">',
    portalcompanyname:
      '<div class="sgfrm za-company-container"> <div class="wrap-elm"><span class="placeholder">' +
      customvar.companyName +
    ...
    portal:
      '<div class="sgfrm za-company-container"> <div class="wrap-elm"><div class="za-company-box"><span class="portal-id" id="sPortalInpId">https://' +
      customvar.productName +
      "." +
      Zdomain +
      "." +
      dcdomainOne +
      '/portal/</span><input class="portal-input dummyclass" id="portal" name="x_portal" type="text"></div> </div></div>',
    companywithportal:
      '<div class="sgfrm za-company-container"><div class="wrap-elm"><span class="placeholder">' +
      customvar.companyName +
    ...
    customselect:
      ...
      (typeof customvar.signupObj.customselect != "undefined"
        ? customvar.signupObj.customselect.options
        : "") +
      "</select></div></div>",
    customselectone:
      '<div class="sgfrm za-select-container"><div class="wrap-elm"><select id="customselect" class="dummyclass">' +
  ...
  customvar.singleFieldSingupFlow = {
    email:
      '<div class="za-email-container sgfrm zwc_sfield"><div class="wrap-elm col"><span class="placeholder">' +
      customvar.email +
      '</span><input class="dummyclass" id="email" name="email" placeholder="' +
      customvar.email +
      '" type="text"></div></div>',
  ...
  customvar.getsfield();
  customvar.nOfSignup =
    typeof customvar.signupObj.nunmberofsignup != "undefined"
      ? customvar.signupObj.nunmberofsignup
      : 0;
  ...
  for (var n in customvar.signupObj) {
    ...
    var m =
      typeof customvar.signupObj[n].required != "undefined"
        ? customvar.signupObj[n].required == true
          ? true
          : false
        : true;
    if (
      ["customelement", "customelementone", "customelementtwo"].includes(n) &&
      customvar.signupObj[n] == ""
    ) {
      m = false;
    }
    if (typeof customvar.signupflow[o] != "undefined" && m) {
      ...
      if (
        typeof customvar.signupObj.singlefield != "undefined" &&
        customvar.signupObj.singlefield &&
        customvar.singleFieldSingupFlow[o]
      ) {
      ...
      for (var j in customvar.signupObj[n]) {
        ...
        if (h == "nameattr") {
          ...
          if (
            customvar.signupObj[n][j] == "mobile" &&
            customvar.productName == "mail"
          ) {
            $(".dummyclass")
              .parents()
              .find(".mobile-container")
              .addClass("za-mobile-container");
            $(".dummyclass")
              .parents()
              .find(".za-mobile-container")
              ...
              if (h == "class") {
                ...
                if (h == "type") {
                  ...
                  if (
                    ...
                    if (h == "mandatory-dc") {
                      if (
                        customvar.signupObj[n][j]
                          .split(",")
                          .indexOf(dcdomainOne) > -1
                      ) {
                      ...
                      if (h == "mandatory-country") {
                        if (
                          customvar.signupObj[n][j]
                            .split(",")
                            .indexOf(customvar.scountrys.toLowerCase()) > -1
                        ) {
                          $(".dummyclass").attr("mandate", true);
                        } else {
                          $(".dummyclass").attr("mandate", false);
                    ...
                    if (h == "validatetext") {
                      $(".dummyclass").after(
                        '<span class="placetxt zcr-msg-grey">' +
                          customvar.signupObj[n][j] +
                          "</span>"
                      );
                    }
  ...
  customvar.signupcommonelm =
    ...
    '</select> </div><div class="sgnbtnmn"><div class="za-newsletter-container snews-letter" style="display: block;"><label for="newsletter" class="news-signup sign_agree"> <input tabindex="1" class="za-newsletter" type="checkbox" id="newsletter" name="newsletter" value="true" onclick="toggleNewsletterField()"> <span class="icon-medium" id="signup-newsletter"></span> <span>' +
    _txtIwould +
    "</span> </label></div>";
  customvar.signupcommonelm +=
    typeof customvar.signupObj.additionalterms != "undefined"
      ? '<div class="terms-accept sgfrm"><label for="terms-check"><span class="tcheck">&nbsp;</span>' +
        (typeof customvar.signupObj.additionalterms.text != "undefined"
          ? customvar.signupObj.additionalterms.text
          : "") +
        '</label><input class="validatefield" id="terms-check" mandate=' +
        ...
        (typeof customvar.signupObj.additionalterms.nameAttr != "undefined"
          ...
          : "x_I_agree_to_the") +
        '" type="checkbox" value="false"></div>'
      : "";
  customvar.signupcommonelm +=
    '<div class="za-tos-container"><label class="sign_agree" for="tos"><input class="za-tos" id="tos" name="tos" onclick="toggleTosField()"  type="checkbox" value="false"><span class="unchecked" id="signup-termservice">&nbsp;</span>' +
    (currentUrlLang == "jp"
      ? '<a class="stermslink" name="terms" href="https://www.zoho.com/jp/terms.html?src=crm-index" target="_blank" rel="noopener">ã‚µãƒ¼ãƒ“ã‚¹è¦ç´„</a>ãŠã‚ˆã³<a href="https://www.zoho.co.jp/privacy/" target="_blank" class="zrlink" rel="noopener">ãƒ—ãƒ©ã‚¤ãƒã‚·ãƒ¼ãƒãƒªã‚·ãƒ¼</a>ã«åŒæ„ã—ã¾ã™ã€‚'
      : typeof customvar.signupObj.globalagree != "undefined"
      ? customvar.signupObj.globalagree
      : Drupal.t("I agree to the ") +
        ' <a name="terms" href="' +
        ("https://www.zoho.com" + langsrc + "terms.html") +
        '" target="_blank" rel="noopener" class="czone-signup-term">' +
        Drupal.t("Terms of Service") +
        "</a> " +
        Drupal.t("and") +
        ' <a class="zrlink" name="privacy" href="' +
        (typeof customvar.signupObj.privacylink != "undefined"
          ? customvar.signupObj.privacylink
          : "https://www.zoho.com" + langsrc + "privacy.html") +
        "" +
        (typeof customvar.signupObj.privacyparam != "undefined"
          ? customvar.signupObj.privacyparam
          : "") +
  ...
  if ($(".signup-box").hasClass("zsingle-field-form")) {
    $(".zwc_sfield").append(
      '<div class="sgnbtn col"><input class="signupbtn disabled-z-signup" onclick=" return zSignupPrevent();" id="signupbtn" type="submit" value="' +
    ...
    customvar.signupcommonelm +=
      '<div class="sgnbtn"><input class="signupbtn disabled-z-signup" onclick=" return zSignupPrevent();" id="signupbtn" type="submit" value="' +
      (typeof customvar.signupObj.btntext != "undefined"
        ? customvar.signupObj.btntext
        : Drupal.t("Sign Up for Free")) +
      '" style="opacity:0.3;"></div></div>';
    ...
    if (typeof customvar.signupObj.password.passwordgen != "undefined") {
      $("#password").after(
        '<span class="gentext zhide-common">' +
          ...
          "</a> " +
          Drupal.t(
            "The generated password will be copied when you click 'Sign up for free.'"
          ) +
          '</span><span onclick="passwordset();" class="pgen t-tip"><span>Generate password</span></span> <span onclick="copyToClipboard();" class="pcopy t-tip zhide-common">Copy<span class="t-text">Copy</span></span>'
      );
      $(".t-tip")
  ...
  if (typeof customvar.signupObj["social-icon"] != "undefined") {
    ...
    if ($(".signup-box .socl-signup .vi-facebook").length > 0) {
      if (
        typeof $(".signup-box .socl-signup .vi-facebook").attr("style") !=
        "undefined"
      ) {
        if (
          $(".signup-box .socl-signup .vi-facebook")
            .attr("style")
            .indexOf("display: inline") > -1
        ) {
...
customvar.signupEditionHandler = function (k, l) {
  ...
  if (m == "personal") {
    var h = $('.signupcontainer [name="signup_edition"]#personal').attr(
      "checked"
    );
    ...
    if (m == "business") {
      var j = $('.signupcontainer [name="signup_edition"]#business').attr(
        "checked"
      );
...
$(document).on(
  "click",
  '.signupcontainer [name="signup_edition"]',
...
function onSignupReady() {
  ...
  $.validator.addMethod("isValidPhone", function (m, k) {
    ...
    if (
      window.location.host == "www.zoho.com.cn" ||
      window.location.href.indexOf("/zh-hans/") > -1
    ) {
      var l = /^1[34578]\d{9}$/;
      var j = /^[\-\+]+$/;
      if (m != "") {
  ...
  $.validator.addMethod("isreValidPhone", function (k, j) {
    if (
      $("#mobile").val() != k ||
      $("#country_code").val() != $("#confirm_country_code").val()
    ) {
      return false;
    }
    return true;
  ...
  $("#signupform").zaSignUp({
    validator: {
      rules: {
        ...
        x_phone_number: {
          ...
          isValidPhone:
            $("input[name='x_phone_number']").attr("type") == "hidden"
              ? false
              : true,
        },
        x_phone: {
          ...
          isValidPhone:
            $("input[name='x_phone']").attr("type") == "hidden" ? false : true,
        },
        "r_address/1.phone": {
          required: customvar.getmadate("r_address/1.phone"),
          isValidPhone:
            $("input[name='r_address/1.phone']").attr("type") == "hidden"
              ? false
              : true,
        },
        ...
        x_contactnumber: {
          ...
          isValidPhone:
            $("input[name='x_contactnumber']").attr("type") == "hidden"
              ? false
              : true,
        },
        ...
        "r_address/2.phone": {
          ...
          isValidPhone:
            $("input[name='r_address/2.phone']").attr("type") == "hidden"
              ? false
              : true,
        },
    ...
    oncomplete: function (j) {
      ...
      if ($("#mobileotp").length > 0) {
        if (
          $(
            ".form-input.countryCnt.za-country-select.globalcountrycode-signup"
          ).val() != "IN"
        ) {
