!(function (t) {
    ...
    function o(t, e) {
      var n,
        ...
        o = 0,
        s = [];
      for (n = e.querySelectorAll(i || "*"); o < n.length; o++)
        a(n[o]) && s.push(n[o]);
      return s;
    }
    function s(t, e, n) {
            ...
            : 1 &
              (r =
                (t.ownerDocument || t) === (e.ownerDocument || e)
                  ...
                  : 1)
            ? t === document || (t.ownerDocument === A && A.contains(t))
              ? -1
              : e === document || (e.ownerDocument === A && A.contains(e))
              ? 1
              : s
              ? s.indexOf(t) - s.indexOf(e)
              : 0
            : 4 & r
            ? -1
            : 1;
    ...
    function m(t, e) {
      ...
      if (F.test(t)) {
        for (
          o = s.appendChild(document.createElement("div")),
            n = (P.exec(t)[1] || "").toLowerCase(),
            r = z[n] || z._default,
            o.innerHTML = r[1] + t + r[2],
            i = r[0];
          i--;
    ...
    var D = /^(?:\s*(<[\w\W]+>)|#([\w-]+))$/,
      ...
      q = function (e, n) {
        ...
        if ("string" == typeof e) {
          ...
          if (i[1]) {
            if (
              ...
              T.merge(
                this,
                T.parseHTML(i[1], n && n.nodeType ? n.ownerDocument : document)
              ),
              E.test(i[1]) && T.isPlainObject(n))
            )
              for (o in n)
                T.isFunction(this[o]) ? this[o](n[o]) : this.attr(o, n[o]);
            return this;
          }
          return (
            (r = document.getElementById(i[2])),
            (s = this.pushStack(r ? [r] : [])),
            (s.isId = !0),
            s
          );
        }
        return e.nodeType
          ...
          : ((s = T.makeArray(e, this)), e === t && (s.singular = !0), s);
      };
    (q.prototype = {
      splice: y.splice,
      constructor: T,
      ...
      (T.extend = q.prototype.extend =
        function () {
          var t,
            ...
            u = arguments[0] || {};
          for (
            "boolean" == typeof u && ((s = u), (u = arguments[o] || {}), o++),
              a == o && ((u = this), o--),
              T.isFunction(u) || "object" == typeof u || (u = {});
            o < arguments.length;
            o++
          ) {
            r = arguments[o];
    ...
    T.extend({
      ...
      _matches: function (t, e) {
        ...
        for (r = 0; r < n.length; r++) if (T._matches(t, n[r])) return !0;
      },
      ...
      map: function (t, e) {
        var n,
          ...
          o = t.length,
          s = [];
        if (r(t)) for (n = 0; n < o; n++) null != (i = e(t[n], n)) && s.push(i);
        else for (n in t) null != (i = e(t[n], n)) && s.push(i);
        return w.apply([], s);
      },
      grep: function (e, n, r) {
        for (var i = 0, o = !r, s = (e || []).length, a = []; i < s; i++)
          !!n.call(t, e[i], i) === o && a.push(e[i]);
        return a;
      },
      each: function (t, e) {
        var n, i;
      ...
      isPlainObject: function (t) {
        ...
        return (
          ...
          (!(e = Object.getPrototypeOf(t)) ||
            ("function" ==
              typeof (n = S.call(e, "constructor") && e.constructor) &&
              j.call(n) === k))
        );
      },
      parseXML: function (t) {
      ...
      search: function (t, e, n, r, i, o) {
        var s,
          a = [],
          u = !1;
        t.constructor != Array && "object" == typeof t && (t = [t]),
          i && i.recursive && (u = !0),
          e && "string" == typeof e && (e = e.split(".")),
          r
            ? "equals" !== r && "number" == typeof n && (n = n.toString())
            : (r = "includes"),
          e && (s = e[0]);
        for (var c = 0; c < t.length; c++) {
          ...
          if (s) {
              ...
              if (
                ...
                ("any" === r ||
                  ...
                  ("equals" !== r &&
                    "string" == typeof l[s] &&
                    ((!n && l[s] === n) || (n && L[r](l[s], n)))) ||
                  ("number" == typeof l[s] && L[r](l[s].toString(), n)))
              )
                if (o) {
                  if (!u) return !0;
                  a.push(l);
                ...
                for (
                  var f = l[s], h = 1;
                  h < e.length && f instanceof Object && e[h] in f;
                  h++
                ) {
                  var p = f[e[h]];
                  if (
                    ...
                    ("any" === r ||
                      ...
                      ("equals" !== r &&
                        "string" == typeof p &&
                        ((!n && p === n) || (n && L[r](p, n)))) ||
                      ("number" == typeof p && L[r](p.toString(), n)))
                  )
                    if (o) {
                      if (!u) return !0;
                      a.push(f);
            ...
            ("equals" === r && l === n) ||
            ("equals" !== r &&
              (("string" == typeof l && ((!n && l === n) || (n && L[r](l, n)))) ||
                ("number" == typeof l && L[r](l.toString(), n))))
          )
            if (o) {
              if (!u) return !0;
              a.push(l);
          ...
          if (
            u &&
            l[i.children] &&
            (d = this.search(l[i.children], e, n, r, i, !0))
          ) {
      ...
      (function () {
        ...
        (t.type = "checkbox"),
          (T._meta.support.checkOn = "" !== t.value),
          (T._meta.support.optSelected = e.selected),
          ((t = document.createElement("input")).value = "t"),
          (t.type = "radio"),
          (T._meta.support.radioValue = "t" === t.value);
      })(),
      (function () {
        function e() {
          if (o) {
            ...
            (s.style.cssText =
              "position: absolute; left: -2222px;width:300px;height:5px;"),
              (o.style.cssText =
                "position:relative;width:200px;margin: auto; top: 1%;box-sizing:border-box;padding: 20px;"),
              s.appendChild(o),
              a.appendChild(s),
              (e = t.getComputedStyle(o)),
              (n = 50 === l(e.marginLeft)),
              (r = "1%" !== e.top),
              (i = 200 === l(e.width)),
              a.removeChild(s),
      ...
      T.extend(f.prototype, {
        ...
        get: function (t, e) {
          return void 0 === e
            ? this.cache(t)
            : t[this.expando] && t[this.expando][T._camelCase(e)];
        },
        hasData: function (t) {
          var e = t[this.expando];
        ...
        set: function (t, e, n) {
          ...
          else for (r in e) i[T._camelCase(r)] = e[r];
          return i;
        },
        remove: function (t, e) {
          var n,
          ...
          if (void 0 !== r) {
            if (void 0 !== e) {
              n = (e = Array.isArray(e)
                ? e.map(T._camelCase)
                : (e = T._camelCase(e)) in r
                ? [e]
                : e.match(T.regex.rnothtmlwhite) || []).length;
              for (; n--; ) delete r[e[n]];
            }
    ...
    q.prototype.extend({
      ...
      is: function (t) {
        return (
          d(
            this,
            "string" == typeof t && T.needsContext.test(t) ? T(t) : t || [],
            !1
          ).length > 0
        );
      },
      ...
      q.prototype.extend({
        eq: function (t) {
          ...
          return (
            (t = t < 0 ? e + t : t),
            this.pushStack(t < 0 || t > e - 1 ? [] : [this[t]])
          );
        },
        last: function () {
          return this.eq(-1);
        ...
        empty: function () {
          return (
            this.each(function (t, e) {
              1 === e.nodeType &&
                (T.removeLeaks(e.getElementsByTagName("*")),
                (e.textContent = ""));
            }),
            this
          );
    ...
    !(function () {
      ...
      e.setAttribute("type", "radio"),
        ...
        t.appendChild(e),
        (T._meta.support.checkClone = t
          .cloneNode(!0)
          .cloneNode(!0).lastChild.checked),
        (t.innerHTML = "<textarea>x</textarea>"),
        (T._meta.support.noCloneChecked = !!t.cloneNode(!0).lastChild
          .defaultValue);
    })();
    var z = {
      thead: [1, "<table>", "</table>"],
        ...
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((i = M.get(o)),
              1 === o.nodeType && !T._dataPriv.get(o, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  0 === (r = s[n].name).indexOf("data-") &&
                  ((r = T._camelCase(r.slice(5))), v(o, r, i[r]));
    ...
    (function (t) {
      ...
      (n.prototype = {
        ...
        measure: function (t, e) {
          return (
            (t = e ? t.bind(e) : t), this.readOps.push(t), this.stagingFn(), t
          );
        },
        mutate: function (t, e) {
          return (
            (t = e ? t.bind(e) : t), this.writeOps.push(t), this.stagingFn(), t
          );
        },
        stagingFn: function () {
          this.scheduled ||
            ((this.scheduled = !0), e(this.executeTasks.bind(this)));
        },
        executeTasks: function () {
          ...
          if (
            ((this.scheduled = !1),
            (this.readOps.length || this.writeOps.length) && this.stagingFn(),
            t)
          ) {
  ...
  (function () {
    if (window.lyteDomObj) {
      ...
      var hasSL = function (el) {
        return (
          ["loading", "loaded", "applied", "error"].indexOf(getStage(el)) >= 0
        );
      };
      ...
      var load = function (el, props, obj) {
        if (hasLoadEvent(el)) {
          ...
          var bgDataValue =
            ibr && window.devicePixelRatio > 1 && bgHiDpiValue
              ? bgHiDpiValue
              : bg1xValue;
          if (bgDataValue) {
      ...
      var LyteLazyload = function (userProps, els) {
        ...
        data.bgMultiHidpi = data.bgMultiHidpi
          ? data.bgMultiHidpi
          : "bg-multi-hidpi";
        data.poster = data.poster ? data.poster : "poster";
        data.appliedClass = data.appliedClass
          ? data.appliedClass
          : "lyteLazyApplied";
        data.loadingClass = data.loadingClass
          ? data.loadingClass
          : "lyteLazyLoading";
        ...
        data.enteredClass = data.enteredClass
          ? data.enteredClass
          : "lyteLazyEntered";
        data.exitedClass = data.exitedClass ? data.exitedClass : "lyteLazyExited";
        data.removeOnComplete =
          data.removeOnComplete === undefined ? true : data.removeOnComplete;
        data.removeOnEnter =
          data.removeOnEnter === true ? data.removeOnEnter : false;
        data.cancelOnExit =
          data.cancelOnExit === undefined ? true : data.cancelOnExit;
