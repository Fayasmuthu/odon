    ...
    var a = setInterval(function() {
        if ($(".zgh-localization").hasClass("init")) {
            if ($("body").hasClass("i18n-en-in") || $("body").hasClass("i18n-en-au")) {
                ...
                var b = '<li><a href="/crm/index.html?zredirect=f">English (Global)</a></li><li><a data-lang="es-xl" href="/es-xl/crm/">EspaÃ±ol</a></li><li><a data-lang="pt-br" href="/pt-br/crm/">PortuguÃªs (Brasil)</a></li><li><a data-lang="de" href="/de/crm/">Deutsch</a></li><li><a data-lang="fr" href="/fr/crm/">FranÃ§ais</a></li><li><a data-lang="nl" href="/nl/crm/">Nederlands</a></li><li><a data-lang="ar" href="/ar/crm/">Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©</a></li><li><a data-lang="id"  href="/id/crm/">Bahasa Indonesia</a></li><li><a data-lang="th" href="/th/crm/">à¸ à¸²à¸©à¸²à¹„à¸—à¸¢</a></li><li><a data-lang="vi" href="https:/vi/crm/">Tiáº¿ng Viá»‡t</a></li><li><a target="_blank" rel="noopenner" data-lang="zh-hans" href="https://www.zoho.com.cn/crm/">ç®€ä½“ä¸­æ–‡</a></li><li><a data-lang="jp" href="https:/jp/crm/">æ—¥æœ¬èªž</a></li><li><a data-lang="he" href="https:/he/crm/">×¢×‘×¨×™×ª</a></li>';
