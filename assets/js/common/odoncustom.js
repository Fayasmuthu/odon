$ = jQuery.noConflict();
$(".zw-global-header").append('<div class="header"> <a class="logo" href="https://www.zoho.com/"> fayas </a> <div class="signing"></div> </div> <div class="product-header-top slide"> <div class="content-wrap"> <div class="product-title"><a href="/' + $("body").attr("data-prdname") + '/">' + $("body").attr("data-prdname-display") + '</a></div> <div class="zgh-accounts"><a href="https://accounts.zoho.com/signin?servicename=Zohohome&amp;signupurl=https://www.zoho.com/signup.html&amp;serviceurl=https://home.zoho.com" class="zgh-login" style="display: none;">SIGN IN</a><a href="/signup.html?src=index1" class="zgh-signup" style="display: inline-block;">' + Drupal.t("Get Started") + '</a></div> <div class="product-nav-links product-nav-links-new"></div> </div> </div>');
...
var getusername, zPrdSignupLink = "https://www.zoho.com/signup.html",
    zPrdLoginLink = "https://accounts.zoho.com/signin?servicename=ZohoHome&signupurl=https://www.zoho.com/signup.html",
    ZdomainName = "zoho",
...
(function (h) {
    h(document).ready(function (ak) {
        ...
        if (currentUrlLang == "jp") {
            ...
            H = "<li><a href='//www.zoho.com/jp/refund.html'>&#12458;&#12531;&#12521;&#12452;&#12531;&#27770;&#28168;&#24460;&#12398;&#12461;&#12515;&#12531;&#12475;&#12523;&#12395;&#12388;&#12356;&#12390;</a></li>";
        ...
        function aj() {
            ...
            if (!getusername) {
                ...
                if (typeof ap != "undefined" && typeof ap != "") {
                    ...
                    aw = '<a class="user-icon" href="https://accounts.zoho.com/login?' + at + "servicename=" + ap + '">User Icon</a>';
                    _globalAccess = aw
                }
            }
            ...
            if (!customvar.customclean) {
                ...
                if (getusername) {
                    ...
                    if (h(".zh-access").length > 0 && h("body").hasClass("node-type-zoho-home")) {
                        h(".zh-access").attr("href", "https://home." + Zdomain + "." + dcdomainOne + "/home")
                    }
                }
                if (!getusername) {
                    ...
                    if (ar.indexOf(productName) < 0) {
                        ...
                        (productName == "mail") ? (aI = langsrc + "mail/zohomail-pricing.html") : ""
                    }
                    if (ar.indexOf(productName) > -1) {
                        if (productName == "crmplus") {
                            ...
                            if (productName == "crm") {
                                ...
                                if (au != "/crm/index.html" && au != "/crm/zohocrm-pricing.html" && au != "/crm/comparison.html") {
                ...
                h('a[href*="mailto:abuse@zoho.com"]').html("abuse@" + _zcopr + ".com").attr("href", "mailto:abuse@zoho.com");
                if (dcdomainOne == "eu") {
                    h('a[href*="mailto:abuse@zoho.com"]').html("abuse@eu." + _zcopr + ".com").attr("href", "mailto:abuse@zoho.com");
                    h('a[href*="mailto:postmaster@zoho.com"]').html("postmaster@eu." + _zcopr + ".com").attr("href", "mailto:postmaster@zoho.com")
                }
...
$(window).on("load", function () {
    ...
    if (_preZ == window.location.hostname && currentUrlLang != "jp") { } else {
        var m = (customvar.productName == "accounts" || customvar.productName == "contacts") ? "support@zohoaccounts.com" : "support@zoho.com";
    ...
    for (var n = 0; n < l.length; n++) {
        if (l.eq(n).attr("href") != "undefined" && l.eq(n).attr("href") != null && l.eq(n).attr("href") != "" && l.eq(n).attr("data-noneedopener") != "") {
            ...
            if (l.eq(n).attr("href").indexOf("forums.zoho.com") > -1) {
                l.eq(n).attr("href", l.eq(n).attr("href").split("forums.zoho.com").join("help.zoho.com/portal/en/community"))
            }
            if (currentUrlLang != "") {
        ...
        if ($(".cookiestrip").length < 1) {
            ...
            if (!l) {
                if (currentUrlLang == "") {
                    ...
                    var m = (window.location.host == "catalyst.zoho.eu") ? ("https://www.zoho.com/privacy/cookie-policy.html") : (langsrc + "privacy/cookie-policy.html");
                    ...
                    var k = Drupal.t("We use cookies to help us understand and serve you better. Take a look at our ") + '<a href="https://www.zoho.com' + langsrc + 'privacy/cookie-policy.html" target="_blank">' + Drupal.t("Cookie Policy") + ".</a>";
